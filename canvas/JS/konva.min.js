...
!function () {
    ...
    var e = Math.PI / 180, r = {
            ...
            _parseUA: function (t) {
                var e = t.toLowerCase(),
                    ...
                    i = !!t.match(/Android|BlackBerry|iPhone|iPad|iPod|Opera Mini|IEMobile/i), a = !!t.match(/IEMobile/i);
                return {browser: n[1] || "", version: n[2] || "0", isIE: r._detectIE(e), mobile: i, ieMobile: a}
            },
            UA: void 0
        },
    ...
    Konva.Collection = function () {
        var t = [].slice.call(arguments), e = t.length, n = 0;
        ...
        var t, e = [], n = this.length;
        for (t = 0; t < n; t++) e.push(this[t]);
        return e
    }, Konva.Collection.toCollection = function (t) {
        var e, n = new Konva.Collection, i = t.length;
        for (e = 0; e < i; e++) n.push(t[e]);
        return n
    }, Konva.Collection._mapMethod = function (i) {
        Konva.Collection.prototype[i] = function () {
            var t, e = this.length, n = [].slice.call(arguments);
            for (t = 0; t < e; t++) this[t][i].apply(this[t], n);
            return this
        }
        ...
        copy: function () {
            ...
            var e = Math.cos(t), n = Math.sin(t), i = this.m[0] * e + this.m[2] * n, a = this.m[1] * e + this.m[3] * n,
                r = this.m[0] * -n + this.m[2] * e, o = this.m[1] * -n + this.m[3] * e;
            return this.m[0] = i, this.m[1] = a, this.m[2] = r, this.m[3] = o, this
        }, getTranslation: function () {
            return {x: this.m[4], y: this.m[5]}
        }, skew: function (t, e) {
            var n = this.m[0] + this.m[2] * e, i = this.m[1] + this.m[3] * e, a = this.m[2] + this.m[0] * t,
                r = this.m[3] + this.m[1] * t;
            return this.m[0] = n, this.m[1] = i, this.m[2] = a, this.m[3] = r, this
        }, multiply: function (t) {
            var e = this.m[0] * t.m[0] + this.m[2] * t.m[1], n = this.m[1] * t.m[0] + this.m[3] * t.m[1],
                i = this.m[0] * t.m[2] + this.m[2] * t.m[3], a = this.m[1] * t.m[2] + this.m[3] * t.m[3],
            ...
            var t = 1 / (this.m[0] * this.m[3] - this.m[1] * this.m[2]), e = this.m[3] * t, n = -this.m[1] * t,
                i = -this.m[2] * t, a = this.m[0] * t, r = t * (this.m[2] * this.m[5] - this.m[3] * this.m[4]),
                o = t * (this.m[1] * this.m[4] - this.m[0] * this.m[5]);
            return this.m[0] = e, this.m[1] = n, this.m[2] = i, this.m[3] = a, this.m[4] = r, this.m[5] = o, this
        }, getMatrix: function () {
            return this.m
        }, setAbsolutePosition: function (t, e) {
            var n = this.m[0], i = this.m[1], a = this.m[2], r = this.m[3], o = this.m[4],
                s = (n * (e - this.m[5]) - i * (t - o)) / (n * r - i * a), h = (t - o - a * s) / n;
            return this.translate(h, s)
        }
    };
    var e = Math.PI / 180, n = 180 / Math.PI, i = "Konva error: ", a = {
    ...
    Konva.Util = {
        _isElement: function (t) {
            ...
            var e, n, i = [], a = t.length, r = Konva.Util;
            for (e = 0; e < a; e++) n = t[e], r._isNumber(n) ? n = Math.round(1e3 * n) / 1e3 : r._isString(n) || (n = n.toString()), i.push(n);
            return i
        }, _getImage: function (t, e) {
            var n, i;
            if (t) if (this._isElement(t)) e(t); else if (this._isString(t)) (n = new Konva.window.Image).onload = function () {
                e(n)
            }, n.src = t; else if (t.data) {
                (i = Konva.Util.createCanvasElement()).width = t.width, i.height = t.height, i.getContext("2d").putImageData(t, 0, 0), this._getImage(i.toDataURL(), e)
            } else e(null); else e(null)
            ...
            var i = t.prototype;
            for (var a in t.prototype = new n, i) i.hasOwnProperty(a) && (t.prototype[a] = i[a]);
            ...
            var s = Math.sqrt(Math.pow(n - t, 2) + Math.pow(i - e, 2)),
                h = Math.sqrt(Math.pow(a - n, 2) + Math.pow(r - i, 2)), c = o * s / (s + h), l = o * h / (s + h);
            return [n - c * (a - t), i - c * (r - e), n + l * (a - t), i + l * (r - e)]
        }, _expandPoints: function (t, e) {
            var n, i, a = t.length, r = [];
            for (n = 2; n < a - 2; n += 2) i = Konva.Util._getControlPoints(t[n - 2], t[n - 1], t[n], t[n + 1], t[n + 2], t[n + 3], e), r.push(i[0]), r.push(i[1]), r.push(t[n]), r.push(t[n + 1]), r.push(i[2]), r.push(i[3]);
            return r
            ...
            if (0 == c) o = t, s = e, h = (a - n) * (a - n) + (r - i) * (r - i); else {
                var l = ((a - t) * (n - t) + (r - e) * (i - e)) / c;
                h = l < 0 ? ((o = t) - a) * (t - a) + ((s = e) - r) * (e - r) : 1 < l ? ((o = n) - a) * (n - a) + ((s = i) - r) * (i - r) : ((o = t + l * (n - t)) - a) * (o - a) + ((s = e + l * (i - e)) - r) * (s - r)
            }
            return [o, s, h]
        }, _getProjectionToLine: function (s, h, c) {
            var l = Konva.Util.cloneObject(s), d = Number.MAX_VALUE;
            return h.forEach(function (t, e) {
                if (c || e !== h.length - 1) {
                    var n = h[(e + 1) % h.length], i = Konva.Util._getProjectionToSegment(t.x, t.y, n.x, n.y, s.x, s.y),
                        a = i[0], r = i[1], o = i[2];
                    o < d && (l.x = a, l.y = r, d = o)
                }
            }), l
            ...
            for (i = 0; i < e.length; i += 2) r.push({x: e[i], y: e[i + 1]});
            var s = [];
            ...
            var e;
            for (var n in t.visitedByCircularReferenceRemoval = !0, t) if (t.hasOwnProperty(n) && t[n] && "object" == typeof t[n]) if (e = Object.getOwnPropertyDescriptor(t, n), t[n].visitedByCircularReferenceRemoval || Konva.Util._isElement(t[n])) {
    ...
    Konva.Canvas = function (t) {
        ...
        init: function (t) {
            var e = (t || {}).pixelRatio || Konva.pixelRatio || function () {
                ...
                return n = (Konva.window.devicePixelRatio || 1) / (t.webkitBackingStorePixelRatio || t.mozBackingStorePixelRatio || t.msBackingStorePixelRatio || t.oBackingStorePixelRatio || t.backingStorePixelRatio || 1)
            }();
        ...
        var e = t || {}, n = e.width || 0, i = e.height || 0;
    ...
    Konva.Context = function (t) {
        ...
        init: function (t) {
            ...
            var e, n, i, a, r = this.traceArr, o = r.length, s = "";
            for (e = 0; e < o; e++) (i = (n = r[e]).method) ? (a = n.args, s += i, t ? s += "()" : Konva.Util._isArray(a[0]) ? s += "([" + a.join(",") + "])" : s += "(" + a.join(",") + ")") : (s += n.property, t || (s += "=" + n.val)), s += ";";
            return s
        }, clearTrace: function () {
            this.traceArr = []
        }, _trace: function (t) {
            ...
            var t, i, a = this, e = s.length, r = Konva.Util._simplifyArray, n = this.setAttr, o = function (t) {
                var e, n = a[t];
                a[t] = function () {
                    return i = r(Array.prototype.slice.call(arguments, 0)), e = n.apply(a, arguments), a._trace({
                        method: t,
                        args: i
                    }), e
                }
        ...
        _fillColor: function (t) {
            ...
            var e = t.getFillPatternX(), n = t.getFillPatternY(), i = t.getFillPatternScale(),
                a = Konva.getAngle(t.getFillPatternRotation()), r = t.getFillPatternOffset();
            ...
            var e = t.getFillLinearGradientStartPoint(), n = t.getFillLinearGradientEndPoint(),
                i = t.getFillLinearGradientColorStops(), a = this.createLinearGradient(e.x, e.y, n.x, n.y);
            if (i) {
            ...
            var e = t.fill(), n = t.getFillPriority();
            if (e && "color" === n) this._fillColor(t); else {
                var i = t.getFillPatternImage();
                if (i && "pattern" === n) this._fillPattern(t); else {
                    var a = t.getFillLinearGradientColorStops();
                    if (a && "linear-gradient" === n) this._fillLinearGradient(t); else {
                        var r = t.getFillRadialGradientColorStops();
                        r && "radial-gradient" === n ? this._fillRadialGradient(t) : e ? this._fillColor(t) : i ? this._fillPattern(t) : a ? this._fillLinearGradient(t) : r && this._fillRadialGradient(t)
                    }
                }
            }
        }, _strokeLinearGradient: function (t) {
            var e = t.getStrokeLinearGradientStartPoint(), n = t.getStrokeLinearGradientEndPoint(),
                i = t.getStrokeLinearGradientColorStops(), a = this.createLinearGradient(e.x, e.y, n.x, n.y);
            if (i) {
                for (var r = 0; r < i.length; r += 2) a.addColorStop(i[r], i[r + 1]);
                this.setAttr("strokeStyle", a)
            }
        }, _stroke: function (t) {
            var e = t.dash(), n = t.getStrokeScaleEnabled() || t instanceof Konva.Text;
            ...
            var e = Konva.Util, n = e.get(t.getShadowRGBA(), "black"), i = e.get(t.getShadowBlur(), 5),
                a = e.get(t.getShadowOffset(), {x: 0, y: 0}), r = t.getAbsoluteScale(), o = this.canvas.getPixelRatio(),
                s = r.x * o, h = r.y * o;
            this.setAttr("shadowColor", n), this.setAttr("shadowBlur", i * Math.min(Math.abs(s), Math.abs(h))), this.setAttr("shadowOffsetX", a.x * s), this.setAttr("shadowOffsetY", a.y * h)
    ...
    Konva.Factory = {
        addGetterSetter: function (t, e, n, i, a) {
            ...
            var i = d + Konva.Util._capitalize(e);
        ...
        }, addComponentsGetterSetter: function (t, i, e, a, r) {
            var n, o, s = e.length, h = Konva.Util._capitalize, c = d + h(i), l = "set" + h(i);
            t.prototype[c] = function () {
                var t = {};
                for (n = 0; n < s; n++) t[o = e[n]] = this.getAttr(i + h(o));
                return t
            }, t.prototype[l] = function (t) {
                var e, n = this.attrs[i];
                for (e in a && (t = a.call(this, t)), t) t.hasOwnProperty(e) && this._setAttr(i + h(e), t[e]);
                return this._fireChangeEvent(i, n, t), r && r.call(this), this
            }, this.addOverloadedGetterSetter(t, i)
        }, addOverloadedGetterSetter: function (t, e) {
            var n = Konva.Util._capitalize(e), i = "set" + n, a = d + n;
        ...
        }, backCompat: function (i, t) {
            Konva.Util.each(t, function (t, e) {
                var n = i.prototype[e];
                i.prototype[t] = function () {
                    n.apply(this, arguments), Konva.Util.error(t + " method is deprecated and will be removed soon. Use " + e + " instead")
                }
            })
    ...
    "use strict";
    var p = "absoluteOpacity", n = "absoluteTransform", m = "absoluteScale", e = "listening", r = "mouseenter",
        o = "mouseleave", c = "Shape", i = "transform", a = "visible", l = ["id"],
        s = ["xChange.konva", "yChange.konva", "scaleXChange.konva", "scaleYChange.konva", "skewXChange.konva", "skewYChange.konva", "rotationChange.konva", "offsetXChange.konva", "offsetYChange.konva", "transformsEnabledChange.konva"].join(" "),
    ...
    v.Node = function (t) {
        ...
        _init: function (t) {
            this._id = v.idCounter++, this.eventListeners = {}, this.attrs = {}, this._cache = {}, this._filterUpToDate = !1, this._isUnderCache = !1, this.setAttrs(t), this.on(s, function () {
                this._clearCache(i), this._clearSelfAndDescendantCache(n)
            }), this.on(h, function () {
            ...
            var e = t || {}, n = this.getClientRect({skipTransform: !0, relativeTo: this.getParent()}),
                i = e.width || n.width, a = e.height || n.height, r = e.pixelRatio, o = e.x || n.x, s = e.y || n.y,
                h = e.offset || 0, c = e.drawBorder || !1;
            if (i && a) {
                i += 2 * h, a += 2 * h, o -= h, s -= h;
                var l = new v.SceneCanvas({pixelRatio: r, width: i, height: a}),
                    d = new v.SceneCanvas({pixelRatio: r, width: i, height: a}),
                    u = new v.HitCanvas({pixelRatio: 1, width: i, height: a}), f = l.getContext(), g = u.getContext();
                return u.isCache = !0, this.clearCache(), f.save(), g.save(), f.translate(-o, -s), g.translate(-o, -s), this._isUnderCache = !0, this._clearSelfAndDescendantCache(p), this._clearSelfAndDescendantCache(m), this.drawScene(l, this, !0), this.drawHit(u, this, !0), this._isUnderCache = !1, f.restore(), g.restore(), c && (f.save(), f.beginPath(), f.rect(0, 0, i, a), f.closePath(), f.setAttr("strokeStyle", "red"), f.setAttr("lineWidth", 5), f.stroke(), f.restore()), this._cache.canvas = {
                    scene: l,
                    filter: d,
                    hit: u,
                    x: o,
            ...
            setTimeout(function () {
                v.Util.throw("Width or height of caching configuration equals 0. Caching is ignored.")
            })
        }, getClientRect: function () {
            throw new Error('abstract "getClientRect" method call')
        }, _transformedRect: function (t, e) {
            var n, i, a, r, o = [{x: t.x, y: t.y}, {x: t.x + t.width, y: t.y}, {x: t.x + t.width, y: t.y + t.height}, {
                x: t.x,
                y: t.y + t.height
            }], s = this.getAbsoluteTransform(e);
            return o.forEach(function (t) {
                var e = s.point(t);
                void 0 === n && (n = a = e.x, i = r = e.y), n = Math.min(n, e.x), i = Math.min(i, e.y), a = Math.max(a, e.x), r = Math.max(r, e.y)
            }), {x: n, y: i, width: a - n, height: r - i}
            ...
            var e = this._getCachedSceneCanvas(), n = e.pixelRatio;
            ...
            var t, e, n, i, a = this.filters(), r = this._cache.canvas, o = r.scene, s = r.filter, h = s.getContext();
            if (a) {
                if (!this._filterUpToDate) {
                    var c = o.pixelRatio;
                    try {
                        for (t = a.length, h.clear(), h.drawImage(o._canvas, 0, 0, o.getWidth() / c, o.getHeight() / c), e = h.getImageData(0, 0, s.getWidth(), s.getHeight()), n = 0; n < t; n++) "function" == typeof(i = a[n]) ? (i.call(this, e), h.putImageData(e, 0, 0)) : v.Util.error("Filter should be type of function, but got " + typeof i + " insted. Please check correct filters")
                    } catch (t) {
            ...
            var n, i, a, r, o = t.split(" "), s = o.length;
            for (n = 0; n < s; n++) a = (i = o[n].split("."))[0], r = i[1] || "", this.eventListeners[a] || (this.eventListeners[a] = []), this.eventListeners[a].push({
                name: r,
                handler: e
            });
            return this
        }, off: function (t, e) {
            var n, i, a, r, o, s = (t || "").split(" "), h = s.length;
            if (!t) for (i in this.eventListeners) this._off(i);
            for (n = 0; n < h; n++) if (r = (a = s[n].split("."))[0], o = a[1], r) this.eventListeners[r] && this._off(r, o, e); else for (i in this.eventListeners) this._off(i, o, e);
            return this
        ...
        }, _delegate: function (t, i, a) {
            var r = this;
            this.on(t, function (t) {
                for (var e = t.target.findAncestors(i, !0, r), n = 0; n < e.length; n++) (t = v.Util.cloneObject(t)).currentTarget = e[n], a.call(e[n], t)
            })
        }, remove: function () {
            var t = this.getParent();
            return t && t.children && (t.children.splice(this.index, 1), t._setChildrenIndices(), delete this.parent), this._clearSelfAndDescendantCache("stage"), this._clearSelfAndDescendantCache(n), this._clearSelfAndDescendantCache(a), this._clearSelfAndDescendantCache(e), this._clearSelfAndDescendantCache(p), this
        }, destroy: function () {
            v._removeId(this.getId());
            for (var t = (this.getName() || "").split(/\s/g), e = 0; e < t.length; e++) {
                var n = t[e];
                v._removeName(n, this._id)
            }
            ...
            var e, n;
            if (!t) return this;
            for (e in t) "children" !== e && (n = "set" + v.Util._capitalize(e), v.Util._isFunction(this[n]) ? this[n](t[e]) : this._setAttr(e, t[e]));
            return this
            ...
            var n, i, a, r, o = this.getDepth(), s = this, h = 0;
            return "Stage" !== s.nodeType && function t(e) {
                for (n = [], i = e.length, a = 0; a < i; a++) r = e[a], h++, r.nodeType !== c && (n = n.concat(r.getChildren().toArray())), r._id === s._id && (a = i);
                0 < n.length && n[0].getDepth() <= o && t(n)
            ...
            var e = this.getAbsoluteTransform(t).getMatrix(), n = new v.Transform, i = this.offset();
            return n.m = e.slice(), n.translate(i.x, i.y), n.getTranslation()
            ...
            }, this.setPosition({x: t.x, y: t.y}), this._setTransform(n), this
            ...
            return this.attrs.x = 0, this.attrs.y = 0, this.attrs.rotation = 0, this.attrs.scaleX = 1, this.attrs.scaleY = 1, this.attrs.offsetX = 0, this.attrs.offsetY = 0, this.attrs.skewX = 0, this.attrs.skewY = 0, this._clearCache(i), this._clearSelfAndDescendantCache(n), t
        }, move: function (t) {
            ...
            var t, e, n, i = {}, a = this.getAttrs();
            for (t in i.attrs = {}, a) e = a[t], n = this[t], delete a[t], (n ? n.call(this) : null) !== (a[t] = e) && (i.attrs[t] = e);
            return i.className = this.getClassName(), v.Util._prepareToStringify(i)
        }, toJSON: function () {
            ...
            if (!t) return !1;
            var e, n, i = t.replace(/ /g, "").split(","), a = i.length;
            for (e = 0; e < a; e++) if (n = i[e], v.Util.isValidSelector(n) || (v.Util.warn('Selector "' + n + '" is invalid. Allowed selectors examples are "#foo", ".bar" or "Group".'), v.Util.warn('If you have a custom shape with such className, please change it to start with upper letter like "Triangle".'), v.Util.warn("Konva is awesome, right?")), "#" === n.charAt(0)) {
            ...
            var n = 1, i = 1;
            return this._eachAncestorReverse(function (t) {
                n *= t.scaleX(), i *= t.scaleY()
            }, t), {x: n, y: i}
        }, getTransform: function () {
            return this._getCache(i, this._getTransform)
        }, _getTransform: function () {
            var t = new v.Transform, e = this.getX(), n = this.getY(), i = v.getAngle(this.getRotation()),
                a = this.getScaleX(), r = this.getScaleY(), o = this.getSkewX(), s = this.getSkewY(),
                h = this.getOffsetX(), c = this.getOffsetY();
            return 0 === e && 0 === n || t.translate(e, n), 0 !== i && t.rotate(i), 0 === o && 0 === s || t.skew(o, s), 1 === a && 1 === r || t.scale(a, r), 0 === h && 0 === c || t.translate(-1 * h, -1 * c), t
        }, clone: function (t) {
            var e, n, i, a, r, o = v.Util.cloneObject(this.attrs);
            for (var s in l) {
                delete o[l[s]]
            }
            for (e in t) o[e] = t[e];
            var h = new this.constructor(o);
            for (e in this.eventListeners) for (i = (n = this.eventListeners[e]).length, a = 0; a < i; a++) (r = n[a]).name.indexOf("konva") < 0 && (h.eventListeners[e] || (h.eventListeners[e] = []), h.eventListeners[e].push(r));
            return h
        }, _toKonvaCanvas: function (t) {
            t = t || {};
            var e = this.getStage(), n = t.x || 0, i = t.y || 0, a = t.pixelRatio || 1, r = new v.SceneCanvas({
                width: t.width || this.getWidth() || (e ? e.getWidth() : 0),
                height: t.height || this.getHeight() || (e ? e.getHeight() : 0),
                pixelRatio: a
            }), o = r.getContext();
            return o.save(), (n || i) && o.translate(-1 * n, -1 * i), this.drawScene(r), o.restore(), r
        }, toCanvas: function (t) {
            return this._toKonvaCanvas(t)._canvas
        }, toDataURL: function (t) {
            var e = (t = t || {}).mimeType || null, n = t.quality || null;
            return this._toKonvaCanvas(t).toDataURL(e, n)
        }, toImage: function (e) {
            if (!e || !e.callback) throw"callback required for toImage method config argument";
            v.Util._getImage(this.toDataURL(e), function (t) {
                e.callback(t)
            })
        }, setSize: function (t) {
            ...
            var i, a, r, o = this.eventListeners[t];
            for (i = 0; i < o.length; i++) if (a = o[i].name, r = o[i].handler, !("konva" === a && "konva" !== e || e && a !== e || n && n !== r)) {
                if (o.splice(i, 1), 0 === o.length) {
            ...
            var e, n, i = (this.getName() || "").split(/\s/g), a = (t || "").split(/\s/g);
            for (n = 0; n < i.length; n++) e = i[n], -1 === a.indexOf(e) && e && v._removeName(e, this._id);
            for (n = 0; n < a.length; n++) e = a[n], -1 === i.indexOf(e) && e && v._addName(this, e);
            return this._setAttr("name", t), this
        }, addName: function (t) {
            if (!this.hasName(t)) {
                var e = this.name(), n = e ? e + " " + t : t;
                this.setName(n)
            }
            return this
        }, hasName: function (t) {
            ...
            var e = (this.name() || "").split(/\s/g), n = e.indexOf(t);
            return -1 !== n && (e.splice(n, 1), this.setName(e.join(" "))), this
        }, setAttr: function (t, e) {
            var n = this["set" + v.Util._capitalize(t)];
            return v.Util._isFunction(n) ? n.call(this, e) : this._setAttr(t, e), this
        }, _setAttr: function (t, e) {
            var n;
            (n = this.attrs[t]) === e && !v.Util.isObject(e) || (null == e ? delete this.attrs[t] : this.attrs[t] = e, this._fireChangeEvent(t, n, e))
        }, _setComponentAttr: function (t, e, n) {
            var i;
            void 0 !== n && ((i = this.attrs[t]) || (this.attrs[t] = this.getAttr(t)), this.attrs[t][e] = n, this._fireChangeEvent(t, i, n))
        }, _fireAndBubble: function (t, e, n) {
            var i = !0;
            if (e && this.nodeType === c && (e.target = this), t === r && n && (this._id === n._id || this.isAncestorOf && this.isAncestorOf(n)) ? i = !1 : t === o && n && (this._id === n._id || this.isAncestorOf && this.isAncestorOf(n)) && (i = !1), i) {
                this._fire(t, e);
                var a = (t === r || t === o) && n && n.isAncestorOf && n.isAncestorOf(this) && !n.isAncestorOf(this.parent);
            ...
            if ((e = e || {}).currentTarget = this, e.type = t, i) for (n = 0; n < i.length; n++) i[n].handler.call(this, e)
        }, draw: function () {
    ...
    Konva.Filters.Grayscale = function (t) {
        var e, n, i = t.data, a = i.length;
        for (e = 0; e < a; e += 4) n = .34 * i[e] + .5 * i[e + 1] + .16 * i[e + 2], i[e] = n, i[e + 1] = n, i[e + 2] = n
    }
}(), function (t) {
    "use strict";
    t.Filters.Brighten = function (t) {
        var e, n = 255 * this.brightness(), i = t.data, a = i.length;
        for (e = 0; e < a; e += 4) i[e] += n, i[e + 1] += n, i[e + 2] += n
    }, t.Factory.addGetterSetter(t.Node, "brightness", 0, null, t.Factory.afterSetFilter)
}(Konva), function () {
    "use strict";
    Konva.Filters.Invert = function (t) {
        var e, n = t.data, i = n.length;
    ...
    var H = [512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437, 420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405, 394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298, 291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456, 446, 437, 428, 420, 412, 404, 396, 388, 381, 374, 367, 360, 354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292, 287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482, 475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405, 399, 394, 389, 383, 378, 373, 368, 364, 359, 354, 350, 345, 341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298, 294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259, 257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456, 451, 446, 442, 437, 433, 428, 424, 420, 416, 412, 408, 404, 400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360, 357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323, 320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292, 289, 287, 285, 282, 280, 278, 275, 273, 271, 269, 267, 265, 263, 261, 259],
        z = [9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24];
    t.Filters.Blur = function (t) {
        var e = Math.round(this.blurRadius());
        0 < e && function (t, e) {
            var n, i, a, r, o, s, h, c, l, d, u, f, g, v, p, m, _, y, S, K, x, C, b, w, F = t.data, T = t.width,
                P = t.height, A = e + e + 1, M = T - 1, k = P - 1, G = e + 1, R = G * (G + 1) / 2, D = new B, L = null,
                O = D, I = null, N = null, U = H[e], E = z[e];
            for (a = 1; a < A; a++) O = O.next = new B, a === G && (L = O);
            for (O.next = D, h = s = 0, i = 0; i < P; i++) {
                for (m = _ = y = S = c = l = d = u = 0, f = G * (K = F[s]), g = G * (x = F[s + 1]), v = G * (C = F[s + 2]), p = G * (b = F[s + 3]), c += R * K, l += R * x, d += R * C, u += R * b, O = D, a = 0; a < G; a++) O.r = K, O.g = x, O.b = C, O.a = b, O = O.next;
                for (a = 1; a < G; a++) r = s + ((M < a ? M : a) << 2), c += (O.r = K = F[r]) * (w = G - a), l += (O.g = x = F[r + 1]) * w, d += (O.b = C = F[r + 2]) * w, u += (O.a = b = F[r + 3]) * w, m += K, _ += x, y += C, S += b, O = O.next;
                for (I = D, N = L, n = 0; n < T; n++) F[s + 3] = b = u * U >> E, 0 !== b ? (b = 255 / b, F[s] = (c * U >> E) * b, F[s + 1] = (l * U >> E) * b, F[s + 2] = (d * U >> E) * b) : F[s] = F[s + 1] = F[s + 2] = 0, c -= f, l -= g, d -= v, u -= p, f -= I.r, g -= I.g, v -= I.b, p -= I.a, r = h + ((r = n + e + 1) < M ? r : M) << 2, c += m += I.r = F[r], l += _ += I.g = F[r + 1], d += y += I.b = F[r + 2], u += S += I.a = F[r + 3], I = I.next, f += K = N.r, g += x = N.g, v += C = N.b, p += b = N.a, m -= K, _ -= x, y -= C, S -= b, N = N.next, s += 4;
                h += T
            }
            for (n = 0; n < T; n++) {
                for (_ = y = S = m = l = d = u = c = 0, f = G * (K = F[s = n << 2]), g = G * (x = F[s + 1]), v = G * (C = F[s + 2]), p = G * (b = F[s + 3]), c += R * K, l += R * x, d += R * C, u += R * b, O = D, a = 0; a < G; a++) O.r = K, O.g = x, O.b = C, O.a = b, O = O.next;
                for (o = T, a = 1; a <= e; a++) s = o + n << 2, c += (O.r = K = F[s]) * (w = G - a), l += (O.g = x = F[s + 1]) * w, d += (O.b = C = F[s + 2]) * w, u += (O.a = b = F[s + 3]) * w, m += K, _ += x, y += C, S += b, O = O.next, a < k && (o += T);
                for (s = n, I = D, N = L, i = 0; i < P; i++) F[3 + (r = s << 2)] = b = u * U >> E, 0 < b ? (b = 255 / b, F[r] = (c * U >> E) * b, F[r + 1] = (l * U >> E) * b, F[r + 2] = (d * U >> E) * b) : F[r] = F[r + 1] = F[r + 2] = 0, c -= f, l -= g, d -= v, u -= p, f -= I.r, g -= I.g, v -= I.b, p -= I.a, r = n + ((r = i + G) < k ? r : k) * T << 2, c += m += I.r = F[r], l += _ += I.g = F[r + 1], d += y += I.b = F[r + 2], u += S += I.a = F[r + 3], I = I.next, f += K = N.r, g += x = N.g, v += C = N.b, p += b = N.a, m -= K, _ -= x, y -= C, S -= b, N = N.next, s += T
            }
        }(t, e)
    }, t.Factory.addGetterSetter(t.Node, "blurRadius", 0, null, t.Factory.afterSetFilter)
}(Konva), function () {
    "use strict";

    function d(t, e, n) {
        var i = 4 * (n * t.width + e), a = [];
    ...
    Konva.Filters.Mask = function (t) {
        var e = function (t, e) {
            var n = d(t, 0, 0), i = d(t, t.width - 1, 0), a = d(t, 0, t.height - 1),
                r = d(t, t.width - 1, t.height - 1), o = e || 10;
            if (u(n, i) < o && u(i, r) < o && u(r, a) < o && u(a, n) < o) {
                for (var s = function (t) {
                    for (var e = [0, 0, 0], n = 0; n < t.length; n++) e[0] += t[n][0], e[1] += t[n][1], e[2] += t[n][2];
                    return e[0] /= t.length, e[1] /= t.length, e[2] /= t.length, e
                }([i, n, r, a]), h = [], c = 0; c < t.width * t.height; c++) {
                    var l = u(s, [t.data[4 * c], t.data[4 * c + 1], t.data[4 * c + 2]]);
                    h[c] = l < o ? 0 : 255
                }
                return h
            }
        ...
        return e && function (t, e) {
            ...
            for (var i = [1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9], a = Math.round(Math.sqrt(i.length)), r = Math.floor(a / 2), o = [], s = 0; s < n; s++) for (var h = 0; h < e; h++) {
                for (var c = s * e + h, l = 0, d = 0; d < a; d++) for (var u = 0; u < a; u++) {
                    var f = s + d - r, g = h + u - r;
                    if (0 <= f && f < n && 0 <= g && g < e) {
                        var v = i[d * a + u];
                        l += t[f * e + g] * v
            ...
            for (var i = [1, 1, 1, 1, 1, 1, 1, 1, 1], a = Math.round(Math.sqrt(i.length)), r = Math.floor(a / 2), o = [], s = 0; s < n; s++) for (var h = 0; h < e; h++) {
                for (var c = s * e + h, l = 0, d = 0; d < a; d++) for (var u = 0; u < a; u++) {
                    var f = s + d - r, g = h + u - r;
                    if (0 <= f && f < n && 0 <= g && g < e) {
                        var v = i[d * a + u];
            ...
            for (var i = [1, 1, 1, 1, 0, 1, 1, 1, 1], a = Math.round(Math.sqrt(i.length)), r = Math.floor(a / 2), o = [], s = 0; s < n; s++) for (var h = 0; h < e; h++) {
                for (var c = s * e + h, l = 0, d = 0; d < a; d++) for (var u = 0; u < a; u++) {
                    var f = s + d - r, g = h + u - r;
                    if (0 <= f && f < n && 0 <= g && g < e) {
                        var v = i[d * a + u];
    ...
    Konva.Filters.RGB = function (t) {
        var e, n, i = t.data, a = i.length, r = this.red(), o = this.green(), s = this.blue();
        for (e = 0; e < a; e += 4) n = (.34 * i[e] + .5 * i[e + 1] + .16 * i[e + 2]) / 255, i[e] = n * r, i[e + 1] = n * o, i[e + 2] = n * s, i[e + 3] = i[e + 3]
    ...
    Konva.Filters.RGBA = function (t) {
        var e, n, i = t.data, a = i.length, r = this.red(), o = this.green(), s = this.blue(), h = this.alpha();
        for (e = 0; e < a; e += 4) n = 1 - h, i[e] = r * h + i[e] * n, i[e + 1] = o * h + i[e + 1] * n, i[e + 2] = s * h + i[e + 2] * n
    }, Konva.Factory.addGetterSetter(Konva.Node, "red", 0, function (t) {
        return this._filterUpToDate = !1, 255 < t ? 255 : t < 0 ? 0 : Math.round(t)
    }), Konva.Factory.addGetterSetter(Konva.Node, "green", 0, function (t) {
        return this._filterUpToDate = !1, 255 < t ? 255 : t < 0 ? 0 : Math.round(t)
    ...
    Konva.Filters.HSV = function (t) {
        var e, n, i, a, r, o = t.data, s = o.length, h = Math.pow(2, this.value()), c = Math.pow(2, this.saturation()),
            l = Math.abs(this.hue() + 360) % 360, d = h * c * Math.cos(l * Math.PI / 180),
            u = h * c * Math.sin(l * Math.PI / 180), f = .299 * h + .701 * d + .167 * u,
            g = .587 * h - .587 * d + .33 * u, v = .114 * h - .114 * d - .497 * u, p = .299 * h - .299 * d - .328 * u,
            m = .587 * h + .413 * d + .035 * u, _ = .114 * h - .114 * d + .293 * u, y = .299 * h - .3 * d + 1.25 * u,
            S = .587 * h - .586 * d - 1.05 * u, K = .114 * h + .886 * d - .2 * u;
        for (e = 0; e < s; e += 4) n = o[e + 0], i = o[e + 1], a = o[e + 2], r = o[e + 3], o[e + 0] = f * n + g * i + v * a, o[e + 1] = p * n + m * i + _ * a, o[e + 2] = y * n + S * i + K * a, o[e + 3] = r
    ...
    Konva.Factory.addGetterSetter(Konva.Node, "hue", 0, null, Konva.Factory.afterSetFilter), Konva.Factory.addGetterSetter(Konva.Node, "saturation", 0, null, Konva.Factory.afterSetFilter), Konva.Factory.addGetterSetter(Konva.Node, "luminance", 0, null, Konva.Factory.afterSetFilter), Konva.Filters.HSL = function (t) {
        var e, n, i, a, r, o = t.data, s = o.length, h = Math.pow(2, this.saturation()),
            c = Math.abs(this.hue() + 360) % 360, l = 127 * this.luminance(), d = 1 * h * Math.cos(c * Math.PI / 180),
            u = 1 * h * Math.sin(c * Math.PI / 180), f = .299 + .701 * d + .167 * u, g = .587 - .587 * d + .33 * u,
            v = .114 - .114 * d - .497 * u, p = .299 - .299 * d - .328 * u, m = .587 + .413 * d + .035 * u,
            _ = .114 - .114 * d + .293 * u, y = .299 - .3 * d + 1.25 * u, S = .587 - .586 * d - 1.05 * u,
            K = .114 + .886 * d - .2 * u;
        for (e = 0; e < s; e += 4) n = o[e + 0], i = o[e + 1], a = o[e + 2], r = o[e + 3], o[e + 0] = f * n + g * i + v * a + l, o[e + 1] = p * n + m * i + _ * a + l, o[e + 2] = y * n + S * i + K * a + l, o[e + 3] = r
    }
}(), function () {
    "use strict";
    Konva.Filters.Emboss = function (t) {
        var e = 10 * this.embossStrength(), n = 255 * this.embossWhiteLevel(), i = this.embossDirection(),
            a = this.embossBlend(), r = 0, o = 0, s = t.data, h = t.width, c = t.height, l = 4 * h, d = c;
        switch (i) {
            case"top-left":
                o = r = -1;
                break;
        ...
        do {
            ...
            do {
                var p = u + 4 * (v - 1), m = o;
                v + m < 1 && (m = 0), h < v + m && (m = 0);
                var _ = g + 4 * (v - 1 + m), y = s[p] - s[_], S = s[p + 1] - s[_ + 1], K = s[p + 2] - s[_ + 2], x = y,
                    C = 0 < x ? x : -x;
                if (C < (0 < S ? S : -S) && (x = S), C < (0 < K ? K : -K) && (x = K), x *= e, a) {
                    var b = s[p] + x, w = s[p + 1] + x, F = s[p + 2] + x;
                    s[p] = 255 < b ? 255 : b < 0 ? 0 : b, s[p + 1] = 255 < w ? 255 : w < 0 ? 0 : w, s[p + 2] = 255 < F ? 255 : F < 0 ? 0 : F
                } else {
                    var T = n - x;
    ...
    function C(t, e, n, i, a) {
        var r = n - e, o = a - i;
        return 0 === r ? i + o / 2 : 0 === o ? i : o * ((t - e) / r) + i
    }

    Konva.Filters.Enhance = function (t) {
        var e, n, i, a, r = t.data, o = r.length, s = r[0], h = s, c = r[1], l = c, d = r[2], u = d, f = this.enhance();
        if (0 !== f) {
            for (a = 0; a < o; a += 4) (e = r[a + 0]) < s ? s = e : h < e && (h = e), (n = r[a + 1]) < c ? c = n : l < n && (l = n), (i = r[a + 2]) < d ? d = i : u < i && (u = i);
            var g, v, p, m, _, y, S, K, x;
            for (h === s && (h = 255, s = 0), l === c && (l = 255, c = 0), u === d && (u = 255, d = 0), 0 < f ? (v = h + f * (255 - h), p = s - f * (s - 0), _ = l + f * (255 - l), y = c - f * (c - 0), K = u + f * (255 - u), x = d - f * (d - 0)) : (v = h + f * (h - (g = .5 * (h + s))), p = s + f * (s - g), _ = l + f * (l - (m = .5 * (l + c))), y = c + f * (c - m), K = u + f * (u - (S = .5 * (u + d))), x = d + f * (d - S)), a = 0; a < o; a += 4) r[a + 0] = C(r[a + 0], s, h, p, v), r[a + 1] = C(r[a + 1], c, l, y, _), r[a + 2] = C(r[a + 2], d, u, x, K)
        }
    }, Konva.Factory.addGetterSetter(Konva.Node, "enhance", 0, null, Konva.Factory.afterSetFilter)
}(), function () {
    "use strict";
    Konva.Filters.Posterize = function (t) {
        var e, n = Math.round(254 * this.levels()) + 1, i = t.data, a = i.length, r = 255 / n;
        for (e = 0; e < a; e += 1) i[e] = Math.floor(i[e] / r) * r
    }, Konva.Factory.addGetterSetter(Konva.Node, "levels", .5, null, Konva.Factory.afterSetFilter)
}(), function () {
    "use strict";
    Konva.Filters.Noise = function (t) {
        var e, n = 255 * this.noise(), i = t.data, a = i.length, r = n / 2;
        for (e = 0; e < a; e += 4) i[e + 0] += r - 2 * r * Math.random(), i[e + 1] += r - 2 * r * Math.random(), i[e + 2] += r - 2 * r * Math.random()
    }, Konva.Factory.addGetterSetter(Konva.Node, "noise", .2, null, Konva.Factory.afterSetFilter)
}(), function () {
    "use strict";
    Konva.Filters.Pixelate = function (t) {
        var e, n, i, a, r, o, s, h, c, l, d, u, f, g, v = Math.ceil(this.pixelSize()), p = t.width, m = t.height,
            _ = Math.ceil(p / v), y = Math.ceil(m / v);
        if (t = t.data, v <= 0) Konva.Util.error("pixelSize value can not be <= 0"); else for (u = 0; u < _; u += 1) for (f = 0; f < y; f += 1) {
            for (c = (h = u * v) + v, d = (l = f * v) + v, g = s = o = r = a = 0, e = h; e < c; e += 1) if (!(p <= e)) for (n = l; n < d; n += 1) m <= n || (a += t[(i = 4 * (p * n + e)) + 0], r += t[i + 1], o += t[i + 2], s += t[i + 3], g += 1);
            for (a /= g, r /= g, o /= g, s /= g, e = h; e < c; e += 1) if (!(p <= e)) for (n = l; n < d; n += 1) m <= n || (t[(i = 4 * (p * n + e)) + 0] = a, t[i + 1] = r, t[i + 2] = o, t[i + 3] = s)
        }
    }, Konva.Factory.addGetterSetter(Konva.Node, "pixelSize", 8, null, Konva.Factory.afterSetFilter)
}(), function () {
    "use strict";
    Konva.Filters.Threshold = function (t) {
        var e, n = 255 * this.threshold(), i = t.data, a = i.length;
        for (e = 0; e < a; e += 1) i[e] = i[e] < n ? 0 : 255
     ...
     */Konva.Filters.Sepia = function (t) {
        var e, n, i, a, r, o, s, h, c, l = t.data, d = t.width, u = t.height, f = 4 * d;
        do {
            for (e = (u - 1) * f, n = d; s = .393 * (a = l[i = e + 4 * (n - 1)]) + .769 * (r = l[i + 1]) + .189 * (o = l[i + 2]), h = .349 * a + .686 * r + .168 * o, c = .272 * a + .534 * r + .131 * o, l[i] = 255 < s ? 255 : s, l[i + 1] = 255 < h ? 255 : h, l[i + 2] = 255 < c ? 255 : c, l[i + 3] = l[i + 3], --n;) ;
        } while (--u)
    }
}(), function () {
    "use strict";
    Konva.Filters.Solarize = function (t) {
        var e = t.data, n = t.width, i = 4 * n, a = t.height;
        do {
            var r = (a - 1) * i, o = n;
            do {
                var s = r + 4 * (o - 1), h = e[s], c = e[s + 1], l = e[s + 2];
                127 < h && (h = 255 - h), 127 < c && (c = 255 - c), 127 < l && (l = 255 - l), e[s] = h, e[s + 1] = c, e[s + 2] = l
            } while (--o)
        } while (--a)
    }
}(), function () {
    ...
    Konva.Filters.Kaleidoscope = function (t) {
        var e, n, i, a, r, o, s, h, c, l = t.width, d = t.height, u = Math.round(this.kaleidoscopePower()),
            f = Math.round(this.kaleidoscopeAngle()), g = Math.floor(l * (f % 360) / 360);
        if (!(u < 1)) {
            var v = Konva.Util.createCanvasElement();
            v.width = l, v.height = d;
            var p = v.getContext("2d").getImageData(0, 0, l, d);
            !function (t, e, n) {
                var i, a, r, o, s = t.data, h = e.data, c = t.width, l = t.height, d = n.polarCenterX || c / 2,
                    u = n.polarCenterY || l / 2, f = 0, g = 0, v = 0, p = 0, m = Math.sqrt(d * d + u * u);
                a = c - d, r = l - u, m = m < (o = Math.sqrt(a * a + r * r)) ? o : m;
                var _, y, S, K, x = l, C = c, b = 360 / C * Math.PI / 180;
                for (y = 0; y < C; y += 1) for (S = Math.sin(y * b), K = Math.cos(y * b), _ = 0; _ < x; _ += 1) a = Math.floor(d + m * _ / x * K), f = s[0 + (i = 4 * ((r = Math.floor(u + m * _ / x * S)) * c + a))], g = s[i + 1], v = s[i + 2], p = s[i + 3], h[0 + (i = 4 * (y + _ * c))] = f, h[i + 1] = g, h[i + 2] = v, h[i + 3] = p
            }(t, p, {polarCenterX: l / 2, polarCenterY: d / 2});
            for (var m = l / Math.pow(2, u); m <= 8;) m *= 2, u -= 1;
            var _ = m = Math.ceil(m), y = 0, S = _, K = 1;
            for (l < g + m && (y = _, S = 0, K = -1), n = 0; n < d; n += 1) for (e = y; e !== S; e += K) h = 4 * (l * n + Math.round(e + g) % l), a = p.data[h + 0], r = p.data[h + 1], o = p.data[h + 2], s = p.data[h + 3], c = 4 * (l * n + e), p.data[c + 0] = a, p.data[c + 1] = r, p.data[c + 2] = o, p.data[c + 3] = s;
            for (n = 0; n < d; n += 1) for (_ = Math.floor(m), i = 0; i < u; i += 1) {
                for (e = 0; e < _ + 1; e += 1) h = 4 * (l * n + e), a = p.data[h + 0], r = p.data[h + 1], o = p.data[h + 2], s = p.data[h + 3], c = 4 * (l * n + 2 * _ - e - 1), p.data[c + 0] = a, p.data[c + 1] = r, p.data[c + 2] = o, p.data[c + 3] = s;
                _ *= 2
            }
            !function (t, e, n) {
                var i, a, r, o, s, h, c = t.data, l = e.data, d = t.width, u = t.height, f = n.polarCenterX || d / 2,
                    g = n.polarCenterY || u / 2, v = 0, p = 0, m = 0, _ = 0, y = Math.sqrt(f * f + g * g);
                a = d - f, r = u - g, y = y < (h = Math.sqrt(a * a + r * r)) ? h : y;
                var S, K, x, C = u, b = d, w = n.polarRotation || 0;
                for (a = 0; a < d; a += 1) for (r = 0; r < u; r += 1) o = a - f, s = r - g, S = Math.sqrt(o * o + s * s) * C / y, K = (K = (180 * Math.atan2(s, o) / Math.PI + 360 + w) % 360) * b / 360, x = Math.floor(K), v = c[0 + (i = 4 * (Math.floor(S) * d + x))], p = c[i + 1], m = c[i + 2], _ = c[i + 3], l[0 + (i = 4 * (r * d + a))] = v, l[i + 1] = p, l[i + 2] = m, l[i + 3] = _
            }(p, t, {polarRotation: 0})
        }
    ...
    t.Filters.Contrast = function (t) {
        var e, n = Math.pow((parseInt(this.contrast()) + 100) / 100, 2), i = t.data, a = i.length, r = 150, o = 150,
            s = 150;
        for (e = 0; e < a; e += 4) r = i[e], o = i[e + 1], s = i[e + 2], r /= 255, r -= .5, r *= n, r += .5, o /= 255, o -= .5, o *= n, o += .5, s /= 255, s -= .5, s *= n, s += .5, r = (r *= 255) < 0 ? 0 : 255 < r ? 255 : r, o = (o *= 255) < 0 ? 0 : 255 < o ? 255 : o, s = (s *= 255) < 0 ? 0 : 255 < s ? 255 : s, i[e] = r, i[e + 1] = o, i[e + 2] = s
    }, t.Factory.addGetterSetter(t.Node, "contrast", 0, null, t.Factory.afterSetFilter)
}(Konva), function () {
    "use strict";
    Konva.Container = function (t) {
        ...
        __init: function (t) {
            ...
            for (var t, e = Konva.Collection.toCollection(this.children), n = 0; n < e.length; n++) delete(t = e[n]).parent, t.index = 0, t.remove();
            return e = null, this.children = new Konva.Collection, this
        }, destroyChildren: function () {
            for (var t, e = Konva.Collection.toCollection(this.children), n = 0; n < e.length; n++) delete(t = e[n]).parent, t.index = 0, t.destroy();
            return e = null, this.children = new Konva.Collection, this
        }, add: function (t) {
            ...
            var n = this.children;
            return this._validateAdd(t), t.index = n.length, t.parent = this, n.push(t), this._fire("add", {child: t}), Konva.DD && t.isDragging() && Konva.DD.anim.setLayers(t.getLayer()), this
        }, destroy: function () {
            ...
            var n = [];
            return "string" == typeof t ? n = this._findByString(t, e) : "function" == typeof t && (n = this._findByFunction(t, e)), Konva.Collection.toCollection(n)
        }, _findByString: function (t) {
            var e, n, i, a, r, o, s, h = [], c = t.replace(/ /g, "").split(","), l = c.length;
            for (e = 0; e < l; e++) if (i = c[e], Konva.Util.isValidSelector(i) || (Konva.Util.warn('Selector "' + i + '" is invalid. Allowed selectors examples are "#foo", ".bar" or "Group".'), Konva.Util.warn('If you have a custom shape with such className, please change it to start with upper letter like "Triangle".'), Konva.Util.warn("Konva is awesome, right?")), "#" === i.charAt(0)) (r = this._getNodeById(i.slice(1))) && h.push(r); else if ("." === i.charAt(0)) a = this._getNodesByName(i.slice(1)), h = h.concat(a); else for (s = (o = this.getChildren()).length, n = 0; n < s; n++) h = h.concat(o[n]._get(i));
            return h
        }, _findByFunction: function (a, r) {
            var o = [], s = function (t) {
                if (!(r && 0 < o.length)) {
                    var e = t.getChildren(), n = e.length;
                    a(t) && (o = o.concat(t));
                    for (var i = 0; i < n; i++) s(e[i])
                }
            };
            return s(this), o
            ...
            for (var e = Konva.Node.prototype._get.call(this, t), n = this.getChildren(), i = n.length, a = 0; a < i; a++) e = e.concat(n[a]._get(t));
            return e
        }, toObject: function () {
            ...
            return this.find("Shape").each(function (t) {
                t.isVisible() && t.intersects(e) && n.push(t)
            }), n
            ...
            var i = this.getLayer(), a = t || i && i.getCanvas(), r = a && a.getContext(), o = this._cache.canvas,
                s = o && o.scene;
            return (this.isVisible() || n) && (!n && s ? (r.save(), i._applyTransform(this, r, e), this._drawCachedSceneCanvas(r), r.restore()) : this._drawChildren(a, "drawScene", e, !1, n)), this
        }, drawHit: function (t, e, n) {
            var i = this.getLayer(), a = t || i && i.hitCanvas, r = a && a.getContext(), o = this._cache.canvas,
                s = o && o.hit;
            return (this.shouldDrawHit(a) || n) && (i && i.clearHitCache(), !n && s ? (r.save(), i._applyTransform(this, r, e), this._drawCachedHitCanvas(r), r.restore()) : this._drawChildren(a, "drawHit", e)), this
        }, _drawChildren: function (e, n, i, a, r) {
            var t, o, s = this.getLayer(), h = e && e.getContext(), c = this.getClipWidth(), l = this.getClipHeight(),
                d = this.getClipFunc(), u = c && l || d;
            if (u && s) {
                h.save();
                var f = this.getAbsoluteTransform(i), g = f.getMatrix();
                h.transform(g[0], g[1], g[2], g[3], g[4], g[5]), h.beginPath(), d ? d.call(this, h, this) : (t = this.getClipX(), o = this.getClipY(), h.rect(t, o, c, l)), h.clip(), g = f.copy().invert().getMatrix(), h.transform(g[0], g[1], g[2], g[3], g[4], g[5])
            }
            this.children.each(function (t) {
                t[n](e, i, a, r)
            }), u && h.restore()
        }, shouldDrawHit: function (t) {
            var e = this.getLayer(), n = Konva.DD && Konva.isDragging() && -1 !== Konva.DD.anim.getLayers().indexOf(e);
            return t && t.isCache || e && e.hitGraphEnabled() && this.isVisible() && !n
        }, getClientRect: function (t) {
            var n, i, a, r, e = (t = t || {}).skipTransform, o = t.relativeTo, s = {x: 0, y: 0, width: 0, height: 0},
                h = this;
            this.children.each(function (t) {
                if (t.getVisible()) {
                    var e = t.getClientRect({relativeTo: h});
                    void 0 === n ? (n = e.x, i = e.y, a = e.x + e.width, r = e.y + e.height) : (n = Math.min(n, e.x), i = Math.min(i, e.y), a = Math.max(a, e.x + e.width), r = Math.max(r, e.y + e.height))
                }
            });
            ...
            return l && (s = {x: n, y: i, width: a - n, height: r - i}), e ? s : this._transformedRect(s, o)
        }
    ...
    f.Shape = function (t) {
        this.__init(t)
    }, f.Util.addMethods(f.Shape, {
        __init: function (t) {
            this.nodeType = "Shape", this._fillFunc = i, this._strokeFunc = a, this._fillFuncHit = r, this._strokeFuncHit = o;
            for (var e, n = f.shapes; !(e = f.Util.getRandomColor()) || e in n;) ;
            n[this.colorKey = e] = this, f.Node.call(this, t), this.on("shadowColorChange.konva shadowBlurChange.konva shadowOffsetChange.konva shadowOpacityChange.konva shadowEnabledChange.konva", s), this.on("shadowColorChange.konva shadowOpacityChange.konva shadowEnabledChange.konva", h)
        }, hasChildren: function () {
            return !1
            ...
            if (this.hasShadow()) {
                var t = f.Util.colorToRGBA(this.shadowColor());
            ...
            return f.Node.prototype.destroy.call(this), delete f.shapes[this.colorKey], this
            ...
            var e = (t = t || {}).skipTransform, n = t.relativeTo, i = this.getSelfRect(),
                a = this.hasStroke() && this.strokeWidth() || 0, r = i.width + a, o = i.height + a,
                s = this.hasShadow() ? this.shadowOffsetX() : 0, h = this.hasShadow() ? this.shadowOffsetY() : 0,
                c = r + Math.abs(s), l = o + Math.abs(h), d = this.hasShadow() && this.shadowBlur() || 0, u = c + 2 * d,
                f = l + 2 * d, g = 0;
            Math.round(a / 2) !== a / 2 && (g = 1);
            var v = {
                width: u + g,
                height: f + g,
                x: -Math.round(a / 2 + d) + Math.min(s, 0) + i.x,
                y: -Math.round(a / 2 + d) + Math.min(h, 0) + i.y
            };
            return e ? v : this._transformedRect(v, n)
        }, drawScene: function (t, e, n, i) {
            var a, r, o = this.getLayer(), s = t || o.getCanvas(), h = s.getContext(), c = this._cache.canvas,
                l = this.sceneFunc(), d = this.hasShadow(), u = this.hasStroke();
            if (!this.isVisible() && !n) return this;
            if (c) return h.save(), o._applyTransform(this, h, e), this._drawCachedSceneCanvas(h), h.restore(), this;
            if (!l) return this;
            if (h.save(), this._useBufferCanvas(n) && !i) {
                if ((r = (a = this.getStage().bufferCanvas).getContext()).clear(), r.save(), r._applyLineJoin(this), !n) if (o) o._applyTransform(this, r, e); else {
                    var f = this.getAbsoluteTransform(e).getMatrix();
                    h.transform(f[0], f[1], f[2], f[3], f[4], f[5])
                }
                l.call(this, r), r.restore();
                var g = a.pixelRatio;
                ...
                if (h._applyLineJoin(this), !n) if (o) o._applyTransform(this, h, e); else {
                    var v = this.getAbsoluteTransform(e).getMatrix();
                    h.transform(v[0], v[1], v[2], v[3], v[4], v[5])
                }
                d && u && !s.hitCanvas ? (h.save(), n || (h._applyOpacity(this), h._applyGlobalCompositeOperation(this)), h._applyShadow(this), l.call(this, h), h.restore(), this.hasFill() && this.getShadowForStrokeEnabled() && l.call(this, h)) : d && !s.hitCanvas ? (h.save(), n || (h._applyOpacity(this), h._applyGlobalCompositeOperation(this)), h._applyShadow(this), l.call(this, h), h.restore()) : (n || (h._applyOpacity(this), h._applyGlobalCompositeOperation(this)), l.call(this, h))
            }
            return h.restore(), this
        }, drawHit: function (t, e, n) {
            var i = this.getLayer(), a = t || i.hitCanvas, r = a.getContext(), o = this.hitFunc() || this.sceneFunc(),
                s = this._cache.canvas, h = s && s.hit;
            if (!this.shouldDrawHit(a) && !n) return this;
            if (i && i.clearHitCache(), h) return r.save(), i._applyTransform(this, r, e), this._drawCachedHitCanvas(r), r.restore(), this;
            if (!o) return this;
            if (r.save(), r._applyLineJoin(this), !n) if (i) i._applyTransform(this, r, e); else {
    ...
    }), f.Collection.mapMethods(f.Shape)
}(Konva), function () {
    "use strict";
    var n = "mouseout", i = "mouseleave", a = "mouseover", r = "mousemove", o = "mousedown", s = "mouseup",
        h = "contextmenu", c = "dblclick", l = "touchstart", d = "touchend", u = "touchmove", f = "wheel", g = "_",
        e = [o, r, s, n, l, u, d, a, f, h], v = e.length;

    function p(e, n) {
        e.content.addEventListener(n, function (t) {
            e[g + n](t)
        }, !1)
    }
        ...
        ___init: function (t) {
            ...
            if ("string" == typeof t) {
                if ("." === t.charAt(0)) {
                    ...
                    var n;
                    n = "#" !== t.charAt(0) ? t : t.slice(1), t = Konva.document.getElementById(n)
                }
            ...
            var t, e = this.children, n = e.length;
            ...
            var e = (t = t || {}).mimeType || null, n = t.quality || null, i = t.x || 0, a = t.y || 0,
                r = new Konva.SceneCanvas({
                    width: t.width || this.getWidth(),
                    height: t.height || this.getHeight(),
                    pixelRatio: t.pixelRatio || 1
                }), o = r.getContext()._context, s = this.children;
            (i || a) && o.translate(-1 * i, -1 * a), s.each(function (t) {
                var e = t.getCanvas().getWidth(), n = t.getCanvas().getHeight(), i = t.getCanvas().getPixelRatio();
            ...
            for (n = a.length - 1; 0 <= n; n--) if (i = a[n].getIntersection(t, e)) return i;
            return null
        }, _resizeDOM: function () {
            if (this.content) {
                var t, e, n = this.getWidth(), i = this.getHeight(), a = this.getChildren(), r = a.length;
                for (this.content.style.width = n + "px", this.content.style.height = i + "px", this.bufferCanvas.setSize(n, i), this.bufferHitCanvas.setSize(n, i), t = 0; t < r; t++) (e = a[t]).setSize(n, i), e.draw()
            }
        }, add: function (t) {
            if (1 < arguments.length) {
                for (var e = 0; e < arguments.length; e++) this.add(arguments[e]);
            ...
            if (!Konva.UA.mobile) {
                this._setPointerPosition(t);
                var e = this.getIntersection(this.getPointerPosition()), n = this.clickStartShape,
                    i = this.clickEndShape, a = !1, r = Konva.DD;
                ...
                }, Konva.dblClickWindow), e && e.isListening() ? ((this.clickEndShape = e)._fireAndBubble(s, {evt: t}), Konva.listenClickTap && n && n._id === e._id && (e._fireAndBubble("click", {evt: t}), a && i && i._id === e._id && e._fireAndBubble(c, {evt: t}))) : (this._fire(s, {
                    evt: t,
                    target: this,
                    currentTarget: this
                }), this._fire("click", {evt: t, target: this, currentTarget: this}), a && this._fire(c, {
                    evt: t,
                    target: this,
                    currentTarget: this
            ...
            this._setPointerPosition(t);
            var e = this.getIntersection(this.getPointerPosition());
            Konva.listenClickTap = !0, e && e.isListening() ? ((this.tapStartShape = e)._fireAndBubble(l, {evt: t}), e.isListening() && e.preventDefault() && t.cancelable && t.preventDefault()) : this._fire(l, {
                evt: t,
                target: this,
                currentTarget: this
            ...
            this._setPointerPosition(t);
            var e = this.getIntersection(this.getPointerPosition()), n = !1;
            Konva.inDblClickWindow ? n = !0 : Konva.inDblClickWindow = !0, clearTimeout(this.dblTimeout), this.dblTimeout = setTimeout(function () {
                Konva.inDblClickWindow = !1
            }, Konva.dblClickWindow), e && e.isListening() ? (e._fireAndBubble(d, {evt: t}), Konva.listenClickTap && this.tapStartShape && e._id === this.tapStartShape._id && (e._fireAndBubble("tap", {evt: t}), n && e._fireAndBubble("dbltap", {evt: t})), e.isListening() && e.preventDefault() && t.cancelable && t.preventDefault()) : (this._fire(d, {
                evt: t,
                target: this,
                currentTarget: this
            }), this._fire("tap", {evt: t, target: this, currentTarget: this}), n && this._fire("dbltap", {
                evt: t,
                target: this,
                currentTarget: this
            })), this._fire("contentTouchend", {evt: t}), Konva.listenClickTap && (this._fire("contentTap", {evt: t}), n && this._fire("contentDbltap", {evt: t})), Konva.listenClickTap = !1
            ...
            Konva.isDragging() || ((e = this.getIntersection(this.getPointerPosition())) && e.isListening() ? (e._fireAndBubble(u, {evt: t}), e.isListening() && e.preventDefault() && t.cancelable && t.preventDefault()) : this._fire(u, {
                ...
                target: this,
                currentTarget: this
            }), this._fire("contentTouchmove", {evt: t})), n && Konva.isDragging() && Konva.DD.node.preventDefault() && t.cancelable && t.preventDefault()
        }, _wheel: function (t) {
            this._setPointerPosition(t);
            var e = this.getIntersection(this.getPointerPosition());
            ...
            var e = this._getContentPosition(), n = null, i = null;
            ...
            null !== n && null !== i && (this.pointerPos = {x: n, y: i})
            ...
            if (this.bufferCanvas = new Konva.SceneCanvas, this.bufferHitCanvas = new Konva.HitCanvas({pixelRatio: 1}), Konva.isBrowser) {
                ...
                t.innerHTML = "", this.content = Konva.document.createElement("div"), this.content.style.position = "relative", this.content.className = "konvajs-content", this.content.setAttribute("role", "presentation"), t.appendChild(this.content), this._resizeDOM()
            }
        }, _onContent: function (t, e) {
            var n, i, a = t.split(" "), r = a.length;
            for (n = 0; n < r; n++) i = a[n], this.content.addEventListener(i, e, !1)
        }, cache: function () {
    ...
    n.BaseLayer = function (t) {
        ...
        ___init: function (t) {
            ...
            if (!n.Node.prototype.moveUp.call(this)) return this;
            var t = this.getStage();
            ...
            n.Util.warn('Can not change width of layer. Use "stage.width(value)" function instead.')
        }, getHeight: function () {
            if (this.parent) return this.parent.getHeight()
        }, setHeight: function () {
            n.Util.warn('Can not change height of layer. Use "stage.height(value)" function instead.')
    ...
    "use strict";
    var h = [{x: 0, y: 0}, {x: -1, y: 0}, {x: -1, y: -1}, {x: 0, y: -1}, {x: 1, y: -1}, {x: 1, y: 0}, {
        x: 1,
        y: 1
    }, {x: 0, y: 1}, {x: -1, y: 1}], c = h.length;
    Konva.Layer = function (t) {
        ...
        ____init: function (t) {
            ...
            for (var o = 1, s = !1; ;) {
                for (i = 0; i < c; i++) {
                    if (a = h[i], (r = (n = this._getIntersection({
                        x: t.x + a.x * o,
                        y: t.y + a.y * o
            ...
            var n = this.hitCanvas.width || 1, i = this.hitCanvas.height || 1, a = Math.round(e) * n + Math.round(t);
            ...
            var e, n, i = this.hitCanvas.pixelRatio,
                a = this.hitCanvas.context.getImageData(Math.round(t.x * i), Math.round(t.y * i), 1, 1).data, r = a[3];
            return 255 === r ? (e = Konva.Util._rgbToHex(a[0], a[1], a[2]), (n = Konva.shapes["#" + e]) ? {shape: n} : {antialiased: !0}) : 0 < r ? {antialiased: !0} : {}
        }, drawScene: function (t, e) {
            var n = this.getLayer(), i = t || n && n.getCanvas();
            return this._fire("beforeDraw", {node: this}), this.getClearBeforeDraw() && i.getContext().clear(), Konva.Container.prototype.drawScene.call(this, i, e), this._fire("draw", {node: this}), this
        }, drawHit: function (t, e) {
            var n = this.getLayer(), i = t || n && n.hitCanvas;
    ...
    Konva.FastLayer = function (t) {
        ...
        ____init: function (t) {
            ...
            var e = this.getLayer(), n = t || e && e.getCanvas();
    ...
    "use strict";
    var l = i.global.performance && i.global.performance.now ? function () {
        return i.global.performance.now()
    } : function () {
    ...
    var e = i.global.requestAnimationFrame || i.global.webkitRequestAnimationFrame || i.global.mozRequestAnimationFrame || i.global.oRequestAnimationFrame || i.global.msRequestAnimationFrame || t;

    function n() {
        return e.apply(i.global, arguments)
    }

    i.Animation = function (t, e) {
        var n = i.Animation;
        this.func = t, this.setLayers(e), this.id = n.animIdCounter++, this.frame = {
            time: 0,
            timeDiff: 0,
            lastTime: l()
        }
        ...
        setLayers: function (t) {
            ...
            var e, n = this.layers, i = n.length;
            for (e = 0; e < i; e++) if (n[e]._id === t._id) return !1;
            return this.layers.push(t), !0
        }, isRunning: function () {
            var t, e = i.Animation.animations, n = e.length;
            for (t = 0; t < n; t++) if (e[t].id === this.id) return !0;
            return !1
        }, start: function () {
            var t = i.Animation;
            return this.stop(), this.frame.timeDiff = 0, this.frame.lastTime = l(), t._addAnimation(this), this
        }, stop: function () {
            return i.Animation._removeAnimation(this), this
    ...
    }, i.Animation.animations = [], i.Animation.animIdCounter = 0, i.Animation.animRunning = !1, i.Animation._addAnimation = function (t) {
        this.animations.push(t), this._handleAnimation()
    }, i.Animation._removeAnimation = function (t) {
        var e, n = t.id, i = this.animations, a = i.length;
        for (e = 0; e < a; e++) if (i[e].id === n) {
            this.animations.splice(e, 1);
            break
        }
    }, i.Animation._runFrames = function () {
        var t, e, n, i, a, r, o, s, h = {}, c = this.animations;
        for (i = 0; i < c.length; i++) if (e = (t = c[i]).layers, n = t.func, t._updateFrameObject(l()), r = e.length, !n || !1 !== n.call(t, t.frame)) for (a = 0; a < r; a++) void 0 !== (o = e[a])._id && (h[o._id] = o);
        for (s in h) h.hasOwnProperty(s) && h[s].draw()
    }, i.Animation._animationLoop = function () {
        var t = i.Animation;
        t.animations.length ? (t._runFrames(), n(t._animationLoop)) : t.animRunning = !1
    }, i.Animation._handleAnimation = function () {
        this.animRunning || (this.animRunning = !0, n(this._animationLoop))
    }, i.BaseLayer.prototype.batchDraw = function () {
        var t = this, e = i.Animation;
        return this.batchAnim || (this.batchAnim = new e(function () {
            t.batchAnim.stop()
        }, this)), this.batchAnim.isRunning() || this.batchAnim.start(), this
    }, i.Stage.prototype.batchDraw = function () {
        return this.getChildren().each(function (t) {
            t.batchDraw()
        }), this
    }
    ...
    "use strict";
    var c = {node: 1, duration: 1, easing: 1, onFinish: 1, yoyo: 1}, l = 0, u = ["fill", "stroke", "shadowColor"],
        d = function (t, e, n, i, a, r, o) {
    ...
    d.prototype = {
        ...
        var e, n, i = this, a = t.node, r = a._id, o = t.easing || Konva.Easings.Linear, s = !!t.yoyo;
        e = void 0 === t.duration ? 1 : 0 === t.duration ? .001 : t.duration, this.node = a, this._id = l++;
        var h = a.getLayer() || (a instanceof Konva.Stage ? a.getLayers() : null);
        for (n in h || Konva.Util.error("Tween constructor have `node` that is not in a layer. Please add node into layer first."), this.anim = new Konva.Animation(function () {
            i.tween.onEnterFrame()
        }, h), this.tween = new d(n, function (t) {
            i._tweenFunc(t)
        }, o, 0, 1, 1e3 * e, s), this._addListeners(), Konva.Tween.attrs[r] || (Konva.Tween.attrs[r] = {}), Konva.Tween.attrs[r][this._id] || (Konva.Tween.attrs[r][this._id] = {}), Konva.Tween.tweens[r] || (Konva.Tween.tweens[r] = {}), t) void 0 === c[n] && this._addAttr(n, t[n]);
        ...
        _addAttr: function (t, e) {
            var n, i, a, r, o, s, h, c = this.node, l = c._id;
            if ((a = Konva.Tween.tweens[l][t]) && delete Konva.Tween.attrs[l][a][t], n = c.getAttr(t), Konva.Util._isArray(e)) for (i = [], o = Math.max(e.length, n.length), "points" === t && e.length !== n.length && (e.length > n.length ? (h = n, n = Konva.Util._prepareArrayForTween(n, e, c.closed())) : (s = e, e = Konva.Util._prepareArrayForTween(e, n, c.closed()))), r = 0; r < o; r++) i.push(e[r] - n[r]); else if (-1 !== u.indexOf(t)) {
                n = Konva.Util.colorToRGBA(n);
                var d = Konva.Util.colorToRGBA(e);
                i = {r: d.r - n.r, g: d.g - n.g, b: d.b - n.b, a: d.a - n.a}
            } else i = e - n;
            Konva.Tween.attrs[l][this._id][t] = {
                start: n,
                diff: i,
                end: e,
                trueEnd: s,
                trueStart: h
            }, Konva.Tween.tweens[l][t] = this._id
        }, _tweenFunc: function (t) {
            var e, n, i, a, r, o, s, h, c = this.node, l = Konva.Tween.attrs[c._id][this._id];
            for (e in l) {
                if (i = (n = l[e]).start, a = n.diff, h = n.end, Konva.Util._isArray(i)) for (r = [], s = Math.max(i.length, h.length), o = 0; o < s; o++) r.push((i[o] || 0) + a[o] * t); else r = -1 !== u.indexOf(e) ? "rgba(" + Math.round(i.r + a.r * t) + "," + Math.round(i.g + a.g * t) + "," + Math.round(i.b + a.b * t) + "," + (i.a + a.a * t) + ")" : i + a * t;
                c.setAttr(e, r)
            }
            ...
            this.tween.onPlay = function () {
                ...
                var t = n.node, e = Konva.Tween.attrs[t._id][n._id];
                e.points && e.points.trueEnd && t.points(e.points.trueEnd), n.onFinish && n.onFinish.call(n)
            }, this.tween.onReset = function () {
                var t = n.node, e = Konva.Tween.attrs[t._id][n._id];
                e.points && e.points.trueStart && t.points(e.points.trueStart), n.onReset && n.onReset()
            }
        }, play: function () {
            ...
            var t, e = this.node._id, n = this._id, i = Konva.Tween.tweens[e];
            for (t in this.pause(), i) delete Konva.Tween.tweens[e][t];
        ...
        BackEaseIn: function (t, e, n, i) {
            return n * (t /= i) * t * (2.70158 * t - 1.70158) + e
        }, BackEaseOut: function (t, e, n, i) {
            return n * ((t = t / i - 1) * t * (2.70158 * t + 1.70158) + 1) + e
        }, BackEaseInOut: function (t, e, n, i) {
            var a = 1.70158;
            return (t /= i / 2) < 1 ? n / 2 * (t * t * ((1 + (a *= 1.525)) * t - a)) + e : n / 2 * ((t -= 2) * t * ((1 + (a *= 1.525)) * t + a) + 2) + e
            ...
            var o = 0;
            return 0 === t ? e : 2 == (t /= i / 2) ? e + n : (r || (r = i * (.3 * 1.5)), !a || a < Math.abs(n) ? (a = n, o = r / 4) : o = r / (2 * Math.PI) * Math.asin(n / a), t < 1 ? a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * i - o) * (2 * Math.PI) / r) * -.5 + e : a * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * i - o) * (2 * Math.PI) / r) * .5 + n + e)
            ...
            return t < i / 2 ? .5 * Konva.Easings.BounceEaseIn(2 * t, 0, n, i) + e : .5 * Konva.Easings.BounceEaseOut(2 * t - i, 0, n, i) + .5 * n + e
    ...
    Konva.DD = {
        anim: new Konva.Animation(function () {
            ...
            var e = Konva.DD, n = e.node;
            if (n) {
                if (!e.isDragging) {
                    var i = n.getStage().getPointerPosition();
                    i || (n.getStage()._setPointerPosition(t), i = n.getStage().getPointerPosition());
                    var a = n.dragDistance();
                    if (Math.max(Math.abs(i.x - e.startPointerPos.x), Math.abs(i.y - e.startPointerPos.y)) < a) return
                }
                n.getStage()._setPointerPosition(t), n._setDragPosition(t), e.isDragging || (e.isDragging = !0, n.fire("dragstart", {
                    type: "dragstart",
                    target: n,
                    evt: t
                }, !0)), n.fire("dragmove", {type: "dragmove", target: n, evt: t}, !0)
            }
        }, _endDragBefore: function (t) {
            var e, n = Konva.DD, i = n.node;
        ...
        var t = Konva.DD, e = this.getStage(), n = this.getLayer(), i = e.getPointerPosition(),
        ...
        var e = Konva.DD, n = this.getStage().getPointerPosition(), i = this.getDragBoundFunc();
        if (n) {
            var a = {x: n.x - e.offset.x, y: n.y - e.offset.y};
    ...
    if (Konva.Node.prototype.__originalRemove = e, Konva.Node.prototype.remove = function () {
        var t = Konva.DD;
    ...
    }, Konva.Factory.addGetterSetter(Konva.Node, "dragBoundFunc"), Konva.Factory.addGetter(Konva.Node, "draggable", !1), Konva.Factory.addOverloadedGetterSetter(Konva.Node, "draggable"), Konva.isBrowser) {
        var t = Konva.document.documentElement;
        t.addEventListener("mouseup", Konva.DD._endDragBefore, !0), t.addEventListener("touchend", Konva.DD._endDragBefore, !0), t.addEventListener("mousemove", Konva.DD._drag), t.addEventListener("touchmove", Konva.DD._drag), t.addEventListener("mouseup", Konva.DD._endDragAfter, !1), t.addEventListener("touchend", Konva.DD._endDragAfter, !1)
    }
}(), function () {
    "use strict";
    Konva.Rect = function (t) {
        ...
        ___init: function (t) {
            ...
            var e = this.getCornerRadius(), n = this.getWidth(), i = this.getHeight();
    ...
    e.Circle = function (t) {
        ...
        _centroid: !0, ___init: function (t) {
            ...
            t.beginPath(), t.arc(0, 0, this.getRadius(), 0, n, !1), t.closePath(), t.fillStrokeShape(this)
        }, getWidth: function () {
    ...
    }, e.Util.extend(e.Circle, e.Shape), e.Factory.addGetterSetter(e.Circle, "radius", 0), e.Factory.addOverloadedGetterSetter(e.Circle, "radius"), e.Collection.mapMethods(e.Circle)
}(Konva), function () {
    "use strict";
    ...
    Konva.Ellipse = function (t) {
        ...
        _centroid: !0, ___init: function (t) {
            ...
            var e = this.getRadiusX(), n = this.getRadiusY();
            t.beginPath(), t.save(), e !== n && t.scale(1, n / e), t.arc(0, 0, e, 0, i, !1), t.restore(), t.closePath(), t.fillStrokeShape(this)
        }, getWidth: function () {
    ...
    i.Arc = function (t) {
        ...
        _centroid: !0, ___init: function (t) {
            i.Shape.call(this, t), this.className = "Arc", this.sceneFunc(this._sceneFunc)
        }, _sceneFunc: function (t) {
            var e = i.getAngle(this.angle()), n = this.clockwise();
            ...
            i.Node.prototype.setWidth.call(this, t), this.getOuterRadius() !== t / 2 && this.setOuterRadius(t / 2)
        }, setHeight: function (t) {
            i.Node.prototype.setHeight.call(this, t), this.getOuterRadius() !== t / 2 && this.setOuterRadius(t / 2)
        }
    }, i.Util.extend(i.Arc, i.Shape), i.Factory.addGetterSetter(i.Arc, "innerRadius", 0), i.Factory.addGetterSetter(i.Arc, "outerRadius", 0), i.Factory.addGetterSetter(i.Arc, "angle", 0), i.Factory.addGetterSetter(i.Arc, "clockwise", !1), i.Collection.mapMethods(i.Arc)
}(Konva), function () {
    "use strict";
    Konva.Image = function (t) {
        ...
        ___init: function (t) {
            ...
            var e, n, i, a = this.getWidth(), r = this.getHeight(), o = this.getImage();
        ...
        var n = new Image;
        n.onload = function () {
            var t = new Konva.Image({image: n});
            e(t)
        }, n.crossOrigin = "Anonymous", n.src = t
    }
}(), function () {
    "use strict";
    var t, M = "auto", y = "justify", e = "2d",
        n = ["fontFamily", "fontSize", "fontStyle", "fontVariant", "padding", "align", "lineHeight", "text", "width", "height", "wrap", "ellipsis", "letterSpacing"],
        i = n.length;
    ...
    Konva.Text = function (t) {
        ...
        ___init: function (t) {
            ...
            for (var e = 0; e < i; e++) this.on(n[e] + "Change.konva", this._setTextData);
            this._setTextData(), this.sceneFunc(this._sceneFunc), this.hitFunc(this._hitFunc)
        }, _sceneFunc: function (t) {
            var e, n = this.getPadding(), i = this.getTextHeight(), a = this.getLineHeight() * i, r = this.textArr,
                o = r.length, s = this.getAlign(), h = this.getWidth(), c = this.getLetterSpacing(),
                l = this.textDecoration(), d = this.fill(), u = this.fontSize();
            for (t.setAttr("font", this._getContextFont()), t.setAttr("textBaseline", "middle"), t.setAttr("textAlign", "left"), n ? (t.translate(n, 0), t.translate(0, n + a / 2)) : t.translate(0, a / 2), e = 0; e < o; e++) {
                var f = r[e], g = f.text, v = f.width;
                if (t.save(), "right" === s ? t.translate(h - v - 2 * n, 0) : "center" === s && t.translate((h - v - 2 * n) / 2, 0), -1 !== l.indexOf("underline") && (t.save(), t.beginPath(), t.moveTo(0, Math.round(a / 2)), t.lineTo(Math.round(v), Math.round(a / 2)), t.lineWidth = u / 15, t.strokeStyle = d, t.stroke(), t.restore()), -1 !== l.indexOf("line-through") && (t.save(), t.beginPath(), t.moveTo(0, 0), t.lineTo(Math.round(v), 0), t.lineWidth = u / 15, t.strokeStyle = d, t.stroke(), t.restore()), 0 !== c || s === y) for (var p = g.split(" ").length - 1, m = 0; m < g.length; m++) {
                    var _ = g[m];
                    " " === _ && e !== o - 1 && s === y && t.translate(Math.floor((h - v) / p), 0), this.partialText = _, t.fillStrokeShape(this), t.translate(Math.round(this._getTextSize(_).width) + c, 0)
                } else this.partialText = g, t.fillStrokeShape(this);
            ...
            this.align() === y && (t = t.trim());
            var e = this._getTextWidth(t);
            return this.textArr.push({text: t, width: e})
        }, _getTextWidth: function (t) {
            var e = this.getLetterSpacing(), n = t.length;
            return k().measureText(t).width + (n ? e * (n - 1) : 0)
        }, _setTextData: function () {
            var t = this.getText().split("\n"), e = +this.getFontSize(), n = 0, i = this.getLineHeight() * e,
                a = this.attrs.width, r = this.attrs.height, o = a !== M, s = r !== M, h = this.getPadding(),
                c = a - 2 * h, l = r - 2 * h, d = 0, u = this.getWrap(), f = "none" !== u, g = "char" !== u && f,
                v = this.getEllipsis() && !f;
            this.textArr = [], k().font = this._getContextFont();
            for (var p = 0, m = t.length; p < m; ++p) {
                var _ = t[p], y = v ? this._getTextWidth("…") : 0, S = this._getTextWidth(_);
                if (o && c < S) for (; 0 < _.length;) {
                    for (var K = 0, x = _.length, C = "", b = 0; K < x;) {
                        var w = K + x >>> 1, F = _.slice(0, w + 1), T = this._getTextWidth(F) + y;
                        T <= c ? (K = w + 1, C = F + (v ? "…" : ""), b = T) : x = w
                    }
                    if (!C) break;
                    if (g) {
                        var P, A = _[C.length];
                        0 < (P = (" " === A || "-" === A) && b <= c ? C.length : Math.max(C.lastIndexOf(" "), C.lastIndexOf("-")) + 1) && (K = P, C = C.slice(0, K), b = this._getTextWidth(C))
                    }
                    if (this._addTextLine(C), n = Math.max(n, b), d += i, !f || s && l < d + i) break;
                    if (0 < (_ = _.slice(K)).length && (S = this._getTextWidth(_)) <= c) {
                        this._addTextLine(_), d += i, n = Math.max(n, S);
                        break
                    }
                } else this._addTextLine(_), d += i, n = Math.max(n, S);
                if (s && l < d + i) break
            }
            this.textHeight = e, this.textWidth = n
        }
    }, Konva.Util.extend(Konva.Text, Konva.Shape), Konva.Factory.addGetterSetter(Konva.Text, "fontFamily", "Arial"), Konva.Factory.addGetterSetter(Konva.Text, "fontSize", 12), Konva.Factory.addGetterSetter(Konva.Text, "fontStyle", "normal"), Konva.Factory.addGetterSetter(Konva.Text, "fontVariant", "normal"), Konva.Factory.addGetterSetter(Konva.Text, "padding", 0), Konva.Factory.addGetterSetter(Konva.Text, "align", "left"), Konva.Factory.addGetterSetter(Konva.Text, "lineHeight", 1), Konva.Factory.addGetterSetter(Konva.Text, "wrap", "word"), Konva.Factory.addGetterSetter(Konva.Text, "ellipsis", !1), Konva.Factory.addGetterSetter(Konva.Text, "letterSpacing", 0), Konva.Factory.addGetter(Konva.Text, "text", ""), Konva.Factory.addOverloadedGetterSetter(Konva.Text, "text"), Konva.Factory.addGetterSetter(Konva.Text, "textDecoration", ""), Konva.Collection.mapMethods(Konva.Text)
}(), function () {
    "use strict";
    Konva.Line = function (t) {
        ...
        ___init: function (t) {
            ...
            var e, n, i, a = this.getPoints(), r = a.length, o = this.getTension(), s = this.getClosed(),
                h = this.getBezier();
            if (r) {
                if (t.beginPath(), t.moveTo(a[0], a[1]), 0 !== o && 4 < r) {
                    for (n = (e = this.getTensionPoints()).length, i = s ? 0 : 4, s || t.quadraticCurveTo(e[0], e[1], e[2], e[3]); i < n - 2;) t.bezierCurveTo(e[i++], e[i++], e[i++], e[i++], e[i++], e[i++]);
                    s || t.quadraticCurveTo(e[n - 2], e[n - 1], a[r - 2], a[r - 1])
                } else if (h) for (i = 2; i < r;) t.bezierCurveTo(a[i++], a[i++], a[i++], a[i++], a[i++], a[i++]); else for (i = 2; i < r; i += 2) t.lineTo(a[i], a[i + 1]);
            ...
            var t = this.getPoints(), e = t.length, n = this.getTension(), i = Konva.Util,
            ...
            for (var t, e, n, i = (t = 0 !== this.getTension() ? this._getTensionPoints() : this.getPoints())[0], a = t[0], r = t[1], o = t[1], s = 0; s < t.length / 2; s++) e = t[2 * s], n = t[2 * s + 1], i = Math.min(i, e), a = Math.max(a, e), r = Math.min(r, n), o = Math.max(o, n);
            return {x: Math.round(i), y: Math.round(r), width: Math.round(a - i), height: Math.round(o - r)}
        }
    }, Konva.Util.extend(Konva.Line, Konva.Shape), Konva.Factory.addGetterSetter(Konva.Line, "closed", !1), Konva.Factory.addGetterSetter(Konva.Line, "bezier", !1), Konva.Factory.addGetterSetter(Konva.Line, "tension", 0), Konva.Factory.addGetterSetter(Konva.Line, "points", []), Konva.Collection.mapMethods(Konva.Line)
}(), function () {
    "use strict";
    Konva.Sprite = function (t) {
        ...
        ___init: function (t) {
            ...
            var e = this.getAnimation(), n = this.frameIndex(), i = 4 * n, a = this.getAnimations()[e],
                r = this.frameOffsets(), o = a[i + 0], s = a[i + 1], h = a[i + 2], c = a[i + 3], l = this.getImage();
            if ((this.hasFill() || this.hasStroke()) && (t.beginPath(), t.rect(0, 0, h, c), t.closePath(), t.fillStrokeShape(this)), l) if (r) {
                var d = r[e], u = 2 * n;
                t.drawImage(l, o, s, h, c, d[u + 0], d[u + 1], h, c)
            } else t.drawImage(l, o, s, h, c, 0, 0, h, c)
        }, _hitFunc: function (t) {
            var e = this.getAnimation(), n = this.frameIndex(), i = 4 * n, a = this.getAnimations()[e],
                r = this.frameOffsets(), o = a[i + 2], s = a[i + 3];
            if (t.beginPath(), r) {
                var h = r[e], c = 2 * n;
    ...
    Konva.Path = function (t) {
        ...
        ___init: function (t) {
            ...
            for (var n = 0; n < e.length; n++) {
                var i = e[n].command, a = e[n].points;
                switch (i) {
                    case"L":
                        t.lineTo(a[0], a[1]);
                        break;
                    ...
                    case"Q":
                        ...
                        break;
                    case"A":
                        var r = a[0], o = a[1], s = a[2], h = a[3], c = a[4], l = a[5], d = a[6], u = a[7],
                            f = h < s ? s : h, g = h < s ? 1 : s / h, v = h < s ? h / s : 1;
                        t.translate(r, o), t.rotate(d), t.scale(g, v), t.arc(0, 0, f, c, c + l, 1 - u), t.scale(1 / g, 1 / v), t.rotate(-d), t.translate(-r, -o);
                        break;
                    case"z":
                        t.closePath()
                }
            ...
            for (var t, n, i = e[0], a = e[0], r = e[1], o = e[1], s = 0; s < e.length / 2; s++) t = e[2 * s], n = e[2 * s + 1], i = Math.min(i, t), a = Math.max(a, t), r = Math.min(r, n), o = Math.max(o, n);
            return {x: Math.round(i), y: Math.round(r), width: Math.round(a - i), height: Math.round(o - r)}
        }
        ...
        var s = (a - n) / (i - e + 1e-8), h = Math.sqrt(t * t / (1 + s * s));
        i < e && (h *= -1);
        var c, l = s * h;
        if (i === e) c = {x: r, y: o + l}; else if ((o - n) / (r - e + 1e-8) === s) c = {x: r + h, y: o + l}; else {
            var d, u, f = this.getLineLength(e, n, i, a);
            if (f < 1e-8) return;
            var g = (r - e) * (i - e) + (o - n) * (a - n);
            d = e + (g /= f * f) * (i - e), u = n + g * (a - n);
            var v = this.getLineLength(r, o, d, u), p = Math.sqrt(t * t - v * v);
            h = Math.sqrt(p * p / (1 + s * s)), i < e && (h *= -1), c = {x: d + h, y: u + (l = s * h)}
        }
        return c
        ...
        return {x: s * c(t) + r * l(t) + i * d(t) + e * u(t), y: h * c(t) + o * l(t) + a * d(t) + n * u(t)}
        ...
        return {x: r * s(t) + i * h(t) + e * c(t), y: o * s(t) + a * h(t) + n * c(t)}
    }, Konva.Path.getPointOnEllipticalArc = function (t, e, n, i, a, r) {
        var o = Math.cos(r), s = Math.sin(r), h = n * Math.cos(a), c = i * Math.sin(a);
        return {x: t + (h * o - c * s), y: e + (h * s + c * o)}
        ...
        var a, r = e.split("|"), o = [], s = [], h = 0, c = 0,
            l = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi;
        for (i = 1; i < r.length; i++) {
            var d = r[i], u = d.charAt(0);
            for (d = d.slice(1), s.length = 0; a = l.exec(d);) s.push(a[0]);
            for (var f = [], g = 0, v = s.length; g < v; g++) {
                var p = parseFloat(s[g]);
                isNaN(p) || f.push(p)
            }
            for (; 0 < f.length && !isNaN(f[0]);) {
                var m, _, y, S, K, x, C, b, w, F, T = null, P = [], A = h, M = c;
                switch (u) {
                    case"l":
                        h += f.shift(), c += f.shift(), T = "L", P.push(h, c);
                        break;
                    case"L":
                        h = f.shift(), c = f.shift(), P.push(h, c);
                        break;
                    case"m":
                        var k = f.shift(), G = f.shift();
                        if (h += k, c += G, T = "M", 2 < o.length && "z" === o[o.length - 1].command) for (var R = o.length - 2; 0 <= R; R--) if ("M" === o[R].command) {
                            h = o[R].points[0] + k, c = o[R].points[1] + G;
                            break
                        }
                        P.push(h, c), u = "l";
                        break;
                    case"M":
                        h = f.shift(), c = f.shift(), T = "M", P.push(h, c), u = "L";
                        break;
                    case"h":
                        h += f.shift(), T = "L", P.push(h, c);
                        break;
                    case"H":
                        h = f.shift(), T = "L", P.push(h, c);
                        break;
                    case"v":
                        c += f.shift(), T = "L", P.push(h, c);
                        break;
                    case"V":
                        c = f.shift(), T = "L", P.push(h, c);
                        break;
                    case"C":
                        P.push(f.shift(), f.shift(), f.shift(), f.shift()), h = f.shift(), c = f.shift(), P.push(h, c);
                        break;
                    case"c":
                        P.push(h + f.shift(), c + f.shift(), h + f.shift(), c + f.shift()), h += f.shift(), c += f.shift(), T = "C", P.push(h, c);
                        break;
                    case"S":
                        _ = h, y = c, "C" === (m = o[o.length - 1]).command && (_ = h + (h - m.points[2]), y = c + (c - m.points[3])), P.push(_, y, f.shift(), f.shift()), h = f.shift(), c = f.shift(), T = "C", P.push(h, c);
                        break;
                    case"s":
                        _ = h, y = c, "C" === (m = o[o.length - 1]).command && (_ = h + (h - m.points[2]), y = c + (c - m.points[3])), P.push(_, y, h + f.shift(), c + f.shift()), h += f.shift(), c += f.shift(), T = "C", P.push(h, c);
                        break;
                    case"Q":
                        P.push(f.shift(), f.shift()), h = f.shift(), c = f.shift(), P.push(h, c);
                        break;
                    case"q":
                        P.push(h + f.shift(), c + f.shift()), h += f.shift(), c += f.shift(), T = "Q", P.push(h, c);
                        break;
                    case"T":
                        _ = h, y = c, "Q" === (m = o[o.length - 1]).command && (_ = h + (h - m.points[0]), y = c + (c - m.points[1])), h = f.shift(), c = f.shift(), T = "Q", P.push(_, y, h, c);
                        break;
                    case"t":
                        _ = h, y = c, "Q" === (m = o[o.length - 1]).command && (_ = h + (h - m.points[0]), y = c + (c - m.points[1])), h += f.shift(), c += f.shift(), T = "Q", P.push(_, y, h, c);
                        break;
                    case"A":
                        S = f.shift(), K = f.shift(), x = f.shift(), C = f.shift(), b = f.shift(), w = h, F = c, h = f.shift(), c = f.shift(), T = "A", P = this.convertEndpointToCenterParameterization(w, F, h, c, C, b, S, K, x);
                        break;
                    case"a":
                        S = f.shift(), K = f.shift(), x = f.shift(), C = f.shift(), b = f.shift(), w = h, F = c, h += f.shift(), c += f.shift(), T = "A", P = this.convertEndpointToCenterParameterization(w, F, h, c, C, b, S, K, x)
                }
        ...
        switch (n) {
            ...
            case"C":
                for (a = 0, r = h.getPointOnCubicBezier(0, t, e, i[0], i[1], i[2], i[3], i[4], i[5]), s = .01; s <= 1; s += .01) o = h.getPointOnCubicBezier(s, t, e, i[0], i[1], i[2], i[3], i[4], i[5]), a += h.getLineLength(r.x, r.y, o.x, o.y), r = o;
                return a;
            case"Q":
                for (a = 0, r = h.getPointOnQuadraticBezier(0, t, e, i[0], i[1], i[2], i[3]), s = .01; s <= 1; s += .01) o = h.getPointOnQuadraticBezier(s, t, e, i[0], i[1], i[2], i[3]), a += h.getLineLength(r.x, r.y, o.x, o.y), r = o;
                return a;
            case"A":
                a = 0;
                var c = i[4], l = i[5], d = i[4] + l, u = Math.PI / 180;
                if (Math.abs(c - d) < u && (u = Math.abs(c - d)), r = h.getPointOnEllipticalArc(i[0], i[1], i[2], i[3], c, 0), l < 0) for (s = c - u; d < s; s -= u) o = h.getPointOnEllipticalArc(i[0], i[1], i[2], i[3], s, 0), a += h.getLineLength(r.x, r.y, o.x, o.y), r = o; else for (s = c + u; s < d; s += u) o = h.getPointOnEllipticalArc(i[0], i[1], i[2], i[3], s, 0), a += h.getLineLength(r.x, r.y, o.x, o.y), r = o;
        ...
        var c = h * (Math.PI / 180), l = Math.cos(c) * (t - n) / 2 + Math.sin(c) * (e - i) / 2,
            d = -1 * Math.sin(c) * (t - n) / 2 + Math.cos(c) * (e - i) / 2, u = l * l / (o * o) + d * d / (s * s);
        1 < u && (o *= Math.sqrt(u), s *= Math.sqrt(u));
        var f = Math.sqrt((o * o * (s * s) - o * o * (d * d) - s * s * (l * l)) / (o * o * (d * d) + s * s * (l * l)));
        a === r && (f *= -1), isNaN(f) && (f = 0);
        var g = f * o * d / s, v = f * -s * l / o, p = (t + n) / 2 + Math.cos(c) * g - Math.sin(c) * v,
            m = (e + i) / 2 + Math.sin(c) * g + Math.cos(c) * v, _ = function (t) {
                return Math.sqrt(t[0] * t[0] + t[1] * t[1])
            }, y = function (t, e) {
                return (t[0] * e[0] + t[1] * e[1]) / (_(t) * _(e))
            }, S = function (t, e) {
                return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(y(t, e))
            }, K = S([1, 0], [(l - g) / o, (d - v) / s]), x = [(l - g) / o, (d - v) / s],
            C = [(-1 * l - g) / o, (-1 * d - v) / s], b = S(x, C);
        return y(x, C) <= -1 && (b = Math.PI), 1 <= y(x, C) && (b = 0), 0 === r && 0 < b && (b -= 2 * Math.PI), 1 === r && b < 0 && (b += 2 * Math.PI), [p, m, o, s, K, b, c, r]
    ...
    Konva.TextPath = function (t) {
        ...
        ___init: function (t) {
            var e = this;
            this.dummyCanvas = Konva.Util.createCanvasElement(), this.dataArray = [], this.getKerning = t && t.getKerning, Konva.Shape.call(this, t), this._fillFunc = n, this._strokeFunc = i, this._fillFuncHit = n, this._strokeFuncHit = i, this.className = "TextPath", this.dataArray = Konva.Path.parsePathData(this.attrs.data), this.on("dataChange.konva", function () {
            ...
            var e = this.textDecoration(), n = this.fill(), i = this.fontSize(), a = this.glyphInfo;
            "underline" === e && t.beginPath();
            for (var r = 0; r < a.length; r++) {
                t.save();
                var o = a[r].p0;
                t.translate(o.x, o.y), t.rotate(a[r].rotation), this.partialText = a[r].text, t.fillStrokeShape(this), "underline" === e && (0 === r && t.moveTo(0, i / 2 + 1), t.lineTo(i, i / 2 + 1)), t.restore()
            }
            "underline" === e && (t.strokeStyle = n, t.lineWidth = i / 20, t.stroke()), t.restore()
        }, _hitFunc: function (t) {
            t.beginPath();
            ...
            return e.restore(), {width: n.width, height: parseInt(this.attrs.fontSize, 10)}
        }, _setTextData: function () {
            var c = this, t = this._getTextSize(this.attrs.text), l = this.getLetterSpacing(), d = this.align();
            this.textWidth = t.width, this.textHeight = t.height;
            var u = Math.max(this.textWidth + ((this.attrs.text || "").length - 1) * l, 0);
            this.glyphInfo = [];
            for (var f = 0, e = 0; e < c.dataArray.length; e++) 0 < c.dataArray[e].pathLength && (f += c.dataArray[e].pathLength);
            var n = 0;
            "center" === d && (n = Math.max(0, f / 2 - u / 2)), "right" === d && (n = Math.max(0, f - u));
            for (var g, v, p, i = this.getText().split(""), m = this.getText().split(" ").length - 1, a = -1, _ = 0, y = function () {
                _ = 0;
                for (var t = c.dataArray, e = a + 1; e < t.length; e++) {
                    if (0 < t[e].pathLength) return t[a = e];
                    "M" === t[e].command && (g = {x: t[e].points[0], y: t[e].points[1]})
                }
                return {}
            }, r = function (t) {
                var e = c._getTextSize(t).width + l;
                " " === t && "justify" === d && (e += (f - u) / m);
                var n = 0, i = 0;
                for (v = void 0; .01 < Math.abs(e - n) / e && i < 25;) {
                    i++;
                    for (var a = n; void 0 === p;) (p = y()) && a + p.pathLength < e && (a += p.pathLength, p = void 0);
                    if (p === {} || void 0 === g) return;
                    var r = !1;
                    switch (p.command) {
                        case"L":
                            Konva.Path.getLineLength(g.x, g.y, p.points[0], p.points[1]) > e ? v = Konva.Path.getPointOnLine(e, g.x, g.y, p.points[0], p.points[1], g.x, g.y) : p = void 0;
                            break;
                        case"A":
                            var o = p.points[4], s = p.points[5], h = p.points[4] + s;
                            0 === _ ? _ = o + 1e-8 : n < e ? _ += Math.PI / 180 * s / Math.abs(s) : _ -= Math.PI / 360 * s / Math.abs(s), (s < 0 && _ < h || 0 <= s && h < _) && (_ = h, r = !0), v = Konva.Path.getPointOnEllipticalArc(p.points[0], p.points[1], p.points[2], p.points[3], _, p.points[6]);
                            break;
                        case"C":
                            0 === _ ? _ = e > p.pathLength ? 1e-8 : e / p.pathLength : n < e ? _ += (e - n) / p.pathLength : _ -= (n - e) / p.pathLength, 1 < _ && (_ = 1, r = !0), v = Konva.Path.getPointOnCubicBezier(_, p.start.x, p.start.y, p.points[0], p.points[1], p.points[2], p.points[3], p.points[4], p.points[5]);
                            break;
                        case"Q":
                            0 === _ ? _ = e / p.pathLength : n < e ? _ += (e - n) / p.pathLength : _ -= (n - e) / p.pathLength, 1 < _ && (_ = 1, r = !0), v = Konva.Path.getPointOnQuadraticBezier(_, p.start.x, p.start.y, p.points[0], p.points[1], p.points[2], p.points[3])
                    }
                    void 0 !== v && (n = Konva.Path.getLineLength(g.x, g.y, v.x, v.y)), r && (r = !1, p = void 0)
                }
            }, o = c._getTextSize("C").width + l, s = 0; s < n / o && (r("C"), void 0 !== g && void 0 !== v); s++) g = v;
            for (var h = 0; h < i.length && (r(i[h]), void 0 !== g && void 0 !== v); h++) {
                var S = Konva.Path.getLineLength(g.x, g.y, v.x, v.y), K = 0;
                if (this.getKerning) try {
                    K = this.getKerning(i[h - 1], i[h]) * this.fontSize()
                } catch (t) {
                    K = 0
                }
                g.x += K, v.x += K, this.textWidth += K;
                var x = Konva.Path.getPointOnLine(K + S / 2, g.x, g.y, v.x, v.y), C = Math.atan2(v.y - g.y, v.x - g.x);
                this.glyphInfo.push({transposeX: x.x, transposeY: x.y, text: i[h], rotation: C, p0: g, p1: v}), g = v
            }
        }, getSelfRect: function () {
            var e = [];
            ...
            for (var t, n, i = e[0], a = e[0], r = e[0], o = e[0], s = 0; s < e.length / 2; s++) t = e[2 * s], n = e[2 * s + 1], i = Math.min(i, t), a = Math.max(a, t), r = Math.min(r, n), o = Math.max(o, n);
            var h = this.fontSize();
            return {
                x: Math.round(i) - h / 2,
                y: Math.round(r) - h / 2,
                width: Math.round(a - i) + h,
    ...
    Konva.RegularPolygon = function (t) {
        ...
        _centroid: !0, ___init: function (t) {
            ...
            var e, n, i, a = this.attrs.sides, r = this.attrs.radius;
            for (t.beginPath(), t.moveTo(0, 0 - r), e = 1; e < a; e++) n = r * Math.sin(2 * e * Math.PI / a), i = -1 * r * Math.cos(2 * e * Math.PI / a), t.lineTo(n, i);
    ...
    Konva.Star = function (t) {
        ...
        _centroid: !0, ___init: function (t) {
            ...
            var e = this.innerRadius(), n = this.outerRadius(), i = this.numPoints();
            t.beginPath(), t.moveTo(0, 0 - n);
            for (var a = 1; a < 2 * i; a++) {
                var r = a % 2 == 0 ? n : e, o = r * Math.sin(a * Math.PI / i), s = -1 * r * Math.cos(a * Math.PI / i);
                t.lineTo(o, s)
            }
            t.closePath(), t.fillStrokeShape(this)
        }, getWidth: function () {
    ...
    "use strict";
    var a = ["fontFamily", "fontSize", "fontStyle", "padding", "lineHeight", "text", "width"], c = "right", l = "down",
        d = "left", r = a.length;
    Konva.Label = function (t) {
        ...
        ____init: function (t) {
            ...
            for (e = 0; e < r; e++) t.on(a[e] + "Change.konva", i)
        }, getWidth: function () {
            return this.getText().getWidth()
        }, getHeight: function () {
            return this.getText().getHeight()
        }, _sync: function () {
            var t, e, n, i, a, r, o, s = this.getText(), h = this.getTag();
            if (s && h) {
                switch (t = s.getWidth(), e = s.getHeight(), n = h.getPointerDirection(), i = h.getPointerWidth(), o = h.getPointerHeight(), r = a = 0, n) {
                    case"up":
                        a = t / 2, r = -1 * o;
                        break;
                    case c:
        ...
        ___init: function (t) {
            ...
            var e = this.getWidth(), n = this.getHeight(), i = this.getPointerDirection(), a = this.getPointerWidth(),
                r = this.getPointerHeight(), o = Math.min(this.getCornerRadius(), e / 2, n / 2);
            ...
            var t = 0, e = 0, n = this.getPointerWidth(), i = this.getPointerHeight(), a = this.pointerDirection(),
                r = this.getWidth(), o = this.getHeight();
            return "up" === a ? (e -= i, o += i) : a === l ? o += i : a === d ? (t -= 1.5 * n, r += n) : a === c && (r += 1.5 * n), {
                x: t,
                y: e,
                width: r,
                height: o
    ...
    u.Arrow = function (t) {
        ...
        ____init: function (t) {
            ...
            var e = 2 * Math.PI, n = this.points(), i = n, a = 0 !== this.getTension() && 4 < n.length;
            a && (i = this.getTensionPoints());
            var r, o, s = n.length;
            a ? (r = n[s - 2] - i[s - 2], o = n[s - 1] - i[s - 1]) : (r = n[s - 2] - n[s - 4], o = n[s - 1] - n[s - 3]);
            var h = (Math.atan2(o, r) + e) % e, c = this.pointerLength(), l = this.pointerWidth();
            t.save(), t.beginPath(), t.translate(n[s - 2], n[s - 1]), t.rotate(h), t.moveTo(0, 0), t.lineTo(-c, l / 2), t.lineTo(-c, -l / 2), t.closePath(), t.restore(), this.pointerAtBeginning() && (t.save(), t.translate(n[0], n[1]), a ? (r = i[0] - n[0], o = i[1] - n[1]) : (r = n[2] - n[0], o = n[3] - n[1]), t.rotate((Math.atan2(-o, -r) + e) % e), t.moveTo(0, 0), t.lineTo(-c, l / 2), t.lineTo(-c, -l / 2), t.closePath(), t.restore());
            var d = this.dashEnabled();
            d && (this.attrs.dashEnabled = !1, t.setLineDash([])), t.fillStrokeShape(this), d && (this.attrs.dashEnabled = !0)
        }
    }, u.Util.extend(u.Arrow, u.Line), u.Factory.addGetterSetter(u.Arrow, "pointerLength", 10), u.Factory.addGetterSetter(u.Arrow, "pointerWidth", 10), u.Factory.addGetterSetter(u.Arrow, "pointerAtBeginning", !1), u.Collection.mapMethods(u.Arrow)
}(Konva), function (F) {
    "use strict";
    var e = ["resizeEnabledChange", "rotateHandlerOffsetChange"].join(" "), n = "nodeRect",
        i = ["xChange.resizer", "yChange.resizer", "widthChange.resizer", "heightChange.resizer", "scaleXChange.resizer", "scaleYChange.resizer", "skewXChange.resizer", "skewYChange.resizer", "rotationChange.resizer", "offsetXChange.resizer", "offsetYChange.resizer", "transformsEnabledChange.resizer"].join(" "),
        o = {
            "top-left": -45,
            "top-center": 0,
            "top-right": 45,
    ...
    F.Transformer.prototype = {
        _centroid: !1, ____init: function (t) {
            ...
            var e = t.getClientRect({skipTransform: !0}), n = F.getAngle(t.rotation()),
                i = e.x * t.scaleX() - t.offsetX(), a = e.y * t.scaleY() - t.offsetY();
            return {
                x: t.x() + i * Math.cos(n) + a * Math.sin(-n),
                y: t.y() + a * Math.cos(n) + i * Math.sin(n),
            ...
            var t = new F.Shape({
                ...
                sceneFunc: function (t) {
                    var e = this.getParent(), n = e.getPadding();
                    t.beginPath(), t.rect(-n, -n, this.width() + 2 * n, this.height() + 2 * n), t.moveTo(this.width() / 2, -n), e.rotateEnabled() && t.lineTo(this.width() / 2, -e.rotateHandlerOffset() * F.Util._sign(this.height())), t.fillStrokeShape(this)
                }
            });
            this.add(t)
        }, _handleMouseDown: function (t) {
            this.movingResizer = t.target.name();
            var e = this._getNodeRect(), n = e.width, i = e.height, a = Math.sqrt(Math.pow(n, 2) + Math.pow(i, 2));
            this.sin = i / a, this.cos = n / a, window.addEventListener("mousemove", this._handleMouseMove), window.addEventListener("touchmove", this._handleMouseMove), window.addEventListener("mouseup", this._handleMouseUp, !0), window.addEventListener("touchend", this._handleMouseUp, !0), this._transforming = !0, this.fire("transformstart"), this.getNode().fire("transformstart")
        }, _handleMouseMove: function (t) {
            var e, n, i, a = this.findOne("." + this.movingResizer),
                r = a.getStage().getContent().getBoundingClientRect(), o = r.left, s = r.top, h = {
            ...
            if ("top-left" === this.movingResizer) c && (e = (i = Math.sqrt(Math.pow(this.findOne(".bottom-right").x() - a.x(), 2) + Math.pow(this.findOne(".bottom-right").y() - a.y(), 2))) * this.cos, n = i * this.sin, this.findOne(".top-left").x(this.findOne(".bottom-right").x() - e), this.findOne(".top-left").y(this.findOne(".bottom-right").y() - n)); else if ("top-center" === this.movingResizer) this.findOne(".top-left").y(a.y()); else if ("top-right" === this.movingResizer) {
                c && (e = (i = Math.sqrt(Math.pow(this.findOne(".bottom-left").x() - a.x(), 2) + Math.pow(this.findOne(".bottom-left").y() - a.y(), 2))) * this.cos, n = i * this.sin, this.findOne(".top-right").x(e), this.findOne(".top-right").y(this.findOne(".bottom-left").y() - n));
                var l = a.position();
                this.findOne(".top-left").y(l.y), this.findOne(".bottom-right").x(l.x)
            } else if ("middle-left" === this.movingResizer) this.findOne(".top-left").x(a.x()); else if ("middle-right" === this.movingResizer) this.findOne(".bottom-right").x(a.x()); else if ("bottom-left" === this.movingResizer) c && (e = (i = Math.sqrt(Math.pow(this.findOne(".top-right").x() - a.x(), 2) + Math.pow(this.findOne(".top-right").y() - a.y(), 2))) * this.cos, n = i * this.sin, this.findOne(".bottom-left").x(this.findOne(".top-right").x() - e), this.findOne(".bottom-left").y(n)), l = a.position(), this.findOne(".top-left").x(l.x), this.findOne(".bottom-right").y(l.y); else if ("bottom-center" === this.movingResizer) this.findOne(".bottom-right").y(a.y()); else if ("bottom-right" === this.movingResizer) c && (e = (i = Math.sqrt(Math.pow(this.findOne(".bottom-right").x(), 2) + Math.pow(this.findOne(".bottom-right").y(), 2))) * this.cos, n = i * this.sin, this.findOne(".bottom-right").x(e), this.findOne(".bottom-right").y(n)); else if ("rotater" === this.movingResizer) {
                var d = this.getPadding(), u = this._getNodeRect();
                e = a.x() - u.width / 2, n = -a.y() + u.height / 2;
                var f = Math.atan2(-n, e) + Math.PI / 2;
                u.height < 0 && (f -= Math.PI);
                for (var g = F.getAngle(this.rotation()), v = F.Util._radToDeg(g) + F.Util._radToDeg(f), p = F.getAngle(this.getNode().rotation()), m = F.Util._degToRad(v), _ = this.rotationSnaps(), y = 0; y < _.length; y++) {
                    var S = F.getAngle(_[y]);
                    Math.abs(S - F.Util._degToRad(v)) % (2 * Math.PI) < .1 && (v = F.Util._radToDeg(S), m = F.Util._degToRad(v))
                }
                var K = d, x = d;
                this._fitNodeInto({
                    rotation: F.angleDeg ? v : F.Util._degToRad(v),
                    x: u.x + (u.width / 2 + d) * (Math.cos(p) - Math.cos(m)) + (u.height / 2 + d) * (Math.sin(-p) - Math.sin(-m)) - (K * Math.cos(g) + x * Math.sin(-g)),
                    y: u.y + (u.height / 2 + d) * (Math.cos(p) - Math.cos(m)) + (u.width / 2 + d) * (Math.sin(p) - Math.sin(m)) - (x * Math.cos(g) + K * Math.sin(g)),
                    width: u.width + 2 * d,
                    height: u.height + 2 * d
                })
            ...
            if ("rotater" !== this.movingResizer) {
                ...
                e = C.x, n = C.y;
                var b = this.findOne(".bottom-right").x() - this.findOne(".top-left").x(),
                    w = this.findOne(".bottom-right").y() - this.findOne(".top-left").y();
                this._fitNodeInto({x: e + this.offsetX(), y: n + this.offsetY(), width: b, height: w})
            }
        }, _handleMouseUp: function () {
            this._removeEvents()
        }, _removeEvents: function () {
            this._transforming && (this._transforming = !1, window.removeEventListener("mousemove", this._handleMouseMove), window.removeEventListener("touchmove", this._handleMouseMove), window.removeEventListener("mouseup", this._handleMouseUp, !0), window.removeEventListener("touchend", this._handleMouseUp, !0), this.fire("transformend"), this.getNode().fire("transformend"))
        }, _fitNodeInto: function (t) {
            var e = this.getBoundBoxFunc();
            if (e) {
            ...
            var a = i.getClientRect({skipTransform: !0}), r = this.getPadding(), o = (t.width - 2 * r) / a.width,
                s = (t.height - 2 * r) / a.height, h = F.getAngle(i.getRotation()), c = a.x * o - r, l = a.y * s - r;
            this.getNode().setAttrs({
                scaleX: o,
                scaleY: s,
                x: t.x - (c * Math.cos(h) + l * Math.sin(-h)),
                y: t.y - (l * Math.cos(h) + c * Math.sin(h))
            }), this._settings = !1, this.fire("transform"), this.getNode().fire("transform"), this.update(), this.getLayer().batchDraw()
        }, forceUpdate: function () {
            this._resetTransformCache(), this.update()
        }, update: function () {
            var t = this._getNodeRect(), e = t.width, n = t.height, i = this.enabledHandlers(),
                a = this.resizeEnabled(), r = this.getPadding();
            this.findOne(".top-left").setAttrs({
                x: -r,
                y: -r,
                visible: a && 0 <= i.indexOf("top-left")
            }), this.findOne(".top-center").setAttrs({
                x: e / 2,
                y: -r,
                visible: a && 0 <= i.indexOf("top-center")
            }), this.findOne(".top-right").setAttrs({
                x: e + r,
                y: -r,
                visible: a && 0 <= i.indexOf("top-right")
            }), this.findOne(".middle-left").setAttrs({
                x: -r,
                y: n / 2,
                visible: a && 0 <= i.indexOf("middle-left")
            }), this.findOne(".middle-right").setAttrs({
                x: e + r,
                y: n / 2,
                visible: a && 0 <= i.indexOf("middle-right")
            }), this.findOne(".bottom-left").setAttrs({
                x: -r,
                y: n + r,
                visible: a && 0 <= i.indexOf("bottom-left")
            }), this.findOne(".bottom-center").setAttrs({
                x: e / 2,
                y: n + r,
                visible: a && 0 <= i.indexOf("bottom-center")
            }), this.findOne(".bottom-right").setAttrs({
                x: e + r,
                y: n + r,
                visible: a && 0 <= i.indexOf("bottom-right")
            }), this.findOne(".rotater").setAttrs({
                x: e / 2,
                y: -this.rotateHandlerOffset() * F.Util._sign(n),
                visible: this.rotateEnabled()
            }), this.findOne(".back").setAttrs({width: e, height: n, visible: this.lineEnabled()})
        }, isTransforming: function () {
            return this._transforming
        }, stopTransform: function () {
            this._transforming && this._removeEvents()
        }, destroy: function () {
            F.Group.prototype.destroy.call(this), this.detach(), this._removeEvents()
        }, toObject: function () {
            return F.Node.prototype.toObject.call(this)
        }
    }, F.Util.extend(F.Transformer, F.Group), F.Factory.addGetterSetter(F.Transformer, "enabledHandlers", a, function (t) {
        return t instanceof Array || F.Util.warn("enabledHandlers value should be an array"), t instanceof Array && t.forEach(function (t) {
            -1 === a.indexOf(t) && F.Util.warn("Unknown resizer name: " + t + ". Available names are: " + a.join(", "))
        }), t || []
    }), F.Factory.addGetterSetter(F.Transformer, "resizeEnabled", !0), F.Factory.addGetterSetter(F.Transformer, "rotateEnabled", !0), F.Factory.addGetterSetter(F.Transformer, "rotationSnaps", []), F.Factory.addGetterSetter(F.Transformer, "rotateHandlerOffset", 50), F.Factory.addGetterSetter(F.Transformer, "lineEnabled", !0), F.Factory.addGetterSetter(F.Transformer, "keepRatio", !0), F.Factory.addGetterSetter(F.Transformer, "padding", 0), F.Factory.addOverloadedGetterSetter(F.Transformer, "node"), F.Factory.addGetterSetter(F.Transformer, "boundBoxFunc"), F.Collection.mapMethods(F.Transformer)
}(Konva);